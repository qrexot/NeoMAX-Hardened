...
.method private constructor <init>(Landroid/content/Context;Lgpf;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lgpf;
...
.method private declared-synchronized ensureMappingNotOutdated(Lop1$a;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Lgpf;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Lgpf;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lgpf;
...
.method private declared-synchronized read()V
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lgpf;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lgpf;

    const-string v1, "IdMappingWrapper"

    const-string v3, "empty mapping"

    invoke-interface {v0, v1, v3}, Lgpf;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Lop1$a;->c()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lop1$a;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lop1$a;
    .locals 1
...
.method public declared-synchronized getByInternal(Lop1$a;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Lop1$a;)V
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0}, Lwe8;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)V
...
.method public scheduleWriteCacheToDisk()V
    ...
    invoke-direct {v1, p0}, Lve8;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)V

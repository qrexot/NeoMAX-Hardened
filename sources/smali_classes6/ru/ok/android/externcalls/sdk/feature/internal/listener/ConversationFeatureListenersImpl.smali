...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "notifyNewListener",
        "(Lxe1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V",
        "addFeatureListener",
        ...
        "(Lxe1;)Z",
        "getFeatureRoles",
        "(Lxe1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;",
        "Lbf1;",
        "onFeatureSetChanged",
        "(Lbf1;)V",
...
.method private final getFeaturesRolesMap(Lcf1;)Ljava/util/Map;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {}, Lxe1;->values()[Lxe1;
    ...
    invoke-virtual {p1}, Lcf1;->a()Ljava/util/Map;
...
.method private final notifyListenersWithNewEnabledFeatures(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-static {p1, p2}, Lmkh;->k(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-interface {v3, v1, v4}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lxe1;Z)V

    goto :goto_0

    :cond_1
    invoke-static {p2, p1}, Lmkh;->k(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-interface {v1, p2, v2}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lxe1;Z)V
...
.method private final notifyListenersWithNewFeaturesRoles(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-interface {v3, v1, v5}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lxe1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
.method private final notifyNewListener(Lxe1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->isFeatureEnabled(Lxe1;)Z

    move-result v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Lxe1;Z)V

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeatureRoles(Lxe1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;

    move-result-object v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Lxe1;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
# virtual methods
.method public addFeatureListener(Lxe1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->notifyNewListener(Lxe1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V

    return-void
.end method

.method public getFeatureRoles(Lxe1;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;
    .locals 2
...
.method public isFeatureEnabled(Lxe1;)Z
    .locals 1
...
.method public final onFeatureSetChanged(Lbf1;)V
    .locals 1

    invoke-virtual {p1}, Lbf1;->a()Ljava/util/Set;
...
.method public final onFeaturesPerRoleChanged(Lcf1;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeaturesRolesMap(Lcf1;)Ljava/util/Map;
...
.method public removeFeatureListener(Lxe1;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1

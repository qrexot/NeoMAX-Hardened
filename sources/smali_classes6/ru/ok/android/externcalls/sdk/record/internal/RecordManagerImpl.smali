...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toRecordDescription",
        "(Lgr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;",
        ...
        "current",
        "setMyRecordHistory",
        "(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldih;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V",
        "reportStarted",
        "()V",
        "whoStoppedRecordId",
        "reportStopped",
        ...
        "onError",
        "startRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;Lir7;)V",
        "Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;",
        "stopRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;Lir7;)V",
...
.field private final commandParamsCreator:Lvxf;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl$Companion;-><init>(Lv65;)V
...
.method public constructor <init>(Lgpf;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lru/ok/android/externcalls/sdk/events/RecordEventListener;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lgpf;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lvxf;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Ldih;

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lir7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lir7;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final applyRecordStarted(Lir1$b;)V
    .locals 3

    invoke-virtual {p1}, Lir1$b;->a()Lgr1;

    move-result-object v0

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->toRecordDescription(Lgr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    ...
    invoke-virtual {p1}, Lir1$b;->b()Ldih;

    move-result-object v2

    invoke-direct {p0, v1, v2, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldih;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Ldih;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lir1$b;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lir1$b;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lir7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lir7;Lorg/json/JSONObject;)V
...
.method public static synthetic f(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final notifyListenersWhenActiveRoomChanged(Ldih;Ldih;)V
    .locals 1
...
.method private static final onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lir1$b;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->applyRecordStarted(Lir1$b;)V
...
.method private static final onRecordStarted$lambda$5(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lgpf;
...
.method private final setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldih;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    .locals 3
...
.method private static final startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;Lorg/json/JSONObject;)V
    .locals 0

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnSuccess()Lir7;
...
.method private static final startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lir7;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnError()Lir7;
...
.method private static final stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;Lorg/json/JSONObject;)V
    .locals 1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnSuccess()Lir7;
...
.method private static final stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lir7;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnError()Lir7;
...
.method private final toRecordDescription(Lgr1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    .locals 9

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    invoke-virtual {p1}, Lgr1;->a()Lop1$a;
    ...
    invoke-virtual {p1}, Lgr1;->f()Lb0g;

    move-result-object v2

    invoke-virtual {p1}, Lgr1;->e()J

    move-result-wide v3

    invoke-virtual {p1}, Lgr1;->d()J

    move-result-wide v5

    invoke-virtual {p1}, Lgr1;->b()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {p1}, Lgr1;->c()Ljava/lang/String;

    move-result-object v8

    invoke-direct/range {v0 .. v8}, Lru/ok/android/externcalls/sdk/record/RecordDescription;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lb0g;JJLjava/lang/String;Ljava/lang/String;)V
...
.method public final getRecordAdmin()Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Ldih;
...
.method public onCurrentParticipantActiveRoomChanged(Lbv1$a;)V
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->notifyListenersWhenActiveRoomChanged(Ldih;Ldih;)V
...
.method public onRecordError(Lir1$a;)V
    .locals 0

    invoke-virtual {p1}, Lir1$a;->a()Ljava/lang/String;
...
.method public onRecordStarted(Lir1$b;)V
    ...
    invoke-virtual {v1}, Lgr1;->a()Lop1$a;
    ...
    invoke-direct {v2, p0, p1}, Lxzf;-><init>(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lir1$b;)V

    new-instance p1, Lyzf;

    invoke-direct {p1, p0}, Lyzf;-><init>(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
...
.method public onRecordStopped(Lir1$c;)V
    ...
    invoke-virtual {p1}, Lir1$c;->a()Ldih;
    ...
    invoke-direct {p0, v0, v2, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ldih;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Ldih;
    ...
    invoke-virtual {p1}, Lir1$c;->b()Lop1$a;
...
.method public startRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;Lir7;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lvxf;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getSessionRoomId()Ldih;

    move-result-object v3

    if-nez v3, :cond_1

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Ldih;
    ...
    invoke-virtual/range {v1 .. v9}, Lvxf;->a(ZLjava/lang/String;Ljava/lang/Long;Ldih;Ljava/lang/Long;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ls1i;

    move-result-object v1

    new-instance v2, Lzzf;

    invoke-direct {v2, p1, p2}, Lzzf;-><init>(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lgr7;)V

    new-instance p2, La0g;

    invoke-direct {p2, p0, p1, p3}, La0g;-><init>(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lir7;)V

    invoke-virtual {v0, v1, v2, p2}, Lo1i;->C(Ls1i;Lo1i$c;Lo1i$c;)V

    return-void
.end method

.method public stopRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;Lir7;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getSessionRoomId()Ldih;
    ...
    invoke-virtual {v1, v2, v3}, Lvxf;->b(Ldih;Z)Ls1i;

    move-result-object v1

    new-instance v2, Lvzf;

    invoke-direct {v2, p1, p2}, Lvzf;-><init>(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lgr7;)V

    new-instance p2, Lwzf;

    invoke-direct {p2, p0, p1, p3}, Lwzf;-><init>(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lir7;)V

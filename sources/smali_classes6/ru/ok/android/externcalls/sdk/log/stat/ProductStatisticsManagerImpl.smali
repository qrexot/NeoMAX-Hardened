...
.method public constructor <init>(Lbvj;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/log/stat/ProductStatisticsManagerImpl;->timeProvider:Lbvj;
...
.method public getTime(J)J
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/log/stat/ProductStatisticsManagerImpl;->timeProvider:Lbvj;

    invoke-interface {p1}, Lbvj;->utcTimeMs()J

...
.field private final sender:Lir7;
...
.field private final store:Lir7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lir7;"
        }
...
# direct methods
.method public constructor <init>(Lir7;Lir7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lir7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lir7;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lir7;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Ly6l;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lir7;
    ...
    invoke-virtual {v4, v3}, Ll12$a;->c(Lop1$a;)Ll12$a;

    move-result-object v3

    invoke-virtual {v3, v2}, Ll12$a;->d(Ly6l;)Ll12$a;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lhnb;

    move-result-object v3

    invoke-virtual {v2, v3}, Ll12$a;->b(Lhnb;)Ll12$a;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Lnyk;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Lpd1;-><init>(Ll12;Lnyk;)V

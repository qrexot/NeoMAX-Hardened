...
.method public constructor <init>(Lgpf;)V
    ...
    iput-object p1, p0, Lzk0;->b:Ljava/lang/String;
...
.method public a()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lzk0;->getDeviceNames()[Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lzk0;->c()Lorg/webrtc/CameraEnumerator;
    ...
    invoke-virtual {p0, v4}, Lzk0;->isFrontFacing(Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_0

    new-instance v6, Lkd2$b;

    invoke-direct {v6, v4, v5}, Lkd2$b;-><init>(Ljava/lang/String;Ljava/util/List;)V

    goto :goto_1

    :cond_0
    invoke-virtual {p0, v4}, Lzk0;->isBackFacing(Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_1

    new-instance v6, Lkd2$a;

    invoke-direct {v6, v4, v5}, Lkd2$a;-><init>(Ljava/lang/String;Ljava/util/List;)V

    goto :goto_1

    :cond_1
    new-instance v6, Lkd2$c;

    invoke-direct {v6, v4, v5}, Lkd2$c;-><init>(Ljava/lang/String;Ljava/util/List;)V
...
.method public b(Lee2$a;)Lkd2;
    .locals 3

    invoke-virtual {p0}, Lzk0;->a()Ljava/util/List;

    move-result-object v0

    sget-object v1, Lzk0$a;->$EnumSwitchMapping$0:[I
...
.method public createCapturer(Ljava/lang/String;Lorg/webrtc/CameraVideoCapturer$CameraEventsHandler;Lorg/webrtc/CameraVideoCapturer$CameraConfigurationProvider;)Lorg/webrtc/CameraVideoCapturer;
    ...
    .line 4
    iget-object p2, p0, Lzk0;->a:Lgpf;

    iget-object p3, p0, Lzk0;->b:Ljava/lang/String;

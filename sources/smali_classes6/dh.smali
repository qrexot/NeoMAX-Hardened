...
.method public static final b(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;)Z
    ...
    invoke-static {p0}, Ldh;->a(Ljava/lang/String;)Z
...
.method public static final c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :try_start_1
    invoke-static {p0, v1}, Ldh;->b(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;)Z
    ...
    invoke-static {v0, p1, p0}, Lzl9;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static final d(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Ldh;->f(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public static final e(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :cond_2
    :goto_0
    invoke-static {p0, p1}, Ldh;->d(Landroid/content/Context;Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p0, p1}, Ldh;->c(Landroid/content/Context;Landroid/net/Uri;)Z

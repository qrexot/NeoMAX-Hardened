...
.method public constructor <init>(Lorg/webrtc/MediaCodecWrapperFactory;Ljava/lang/String;Lorg/webrtc/VideoCodecMimeType;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Map;IILorg/webrtc/BitrateAdjuster;Lorg/webrtc/EglBase14$Context;)V
    ...
    invoke-direct {v1, v2}, Lorg/webrtc/HardwareVideoEncoder$BusyCount;-><init>(Lp28;)V
...
.method private initEncodeInternal()Lorg/webrtc/VideoCodecStatus;
    ...
    sget-boolean v4, Lorg/webrtc/HardwareVideoEncoder;->ODKL_CHANGE_CBR_BEHAVIOR:Z
    :try_end_1
    ...
    :try_start_2
    sget-boolean v4, Lorg/webrtc/HardwareVideoEncoder;->ODKL_CBR_SUPPORTED_CHECK:Z

    if-eqz v4, :cond_1

    iget-object v4, p0, Lorg/webrtc/HardwareVideoEncoder;->codec:Lorg/webrtc/MediaCodecWrapper;

    invoke-interface {v4, v3}, Lorg/webrtc/MediaCodecWrapper;->cbrSupported(Landroid/media/MediaFormat;)Z
...
.method public deliverEncodedImage()V
    ...
    new-instance v8, Lo28;

    invoke-direct {v8, p0, v3}, Lo28;-><init>(Lorg/webrtc/HardwareVideoEncoder;I)V

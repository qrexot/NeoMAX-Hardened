...
.method private scheduleLogRecordingConfigurationsTask(Landroid/media/AudioRecord;)V
    ...
    invoke-direct {v0, p0, p1}, Ljnl;-><init>(Lorg/webrtc/audio/WebRtcAudioRecord;Landroid/media/AudioRecord;)V
...
.method public initDeviceAudioRecord(Landroid/media/projection/MediaProjection;)V
    ...
    :try_start_0
    invoke-static {}, Linl;->a()V

    invoke-static {p1}, Lhnl;->a(Landroid/media/projection/MediaProjection;)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    move-result-object v4

    invoke-static {v4, v3}, Lenl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    const/16 v5, 0xe

    invoke-static {v4, v5}, Lenl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    new-instance v5, Landroid/media/AudioRecord$Builder;

    invoke-direct {v5}, Landroid/media/AudioRecord$Builder;-><init>()V

    invoke-static {v4}, Lfnl;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)Landroid/media/AudioPlaybackCaptureConfiguration;

    move-result-object v4

    invoke-static {v5, v4}, Lgnl;->a(Landroid/media/AudioRecord$Builder;Landroid/media/AudioPlaybackCaptureConfiguration;)Landroid/media/AudioRecord$Builder;

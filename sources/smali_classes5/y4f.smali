...
# static fields
.field public static final F:Ly4f$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Ly4f$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Ly4f$a;-><init>(Lv65;)V

    sput-object v0, Ly4f;->F:Ly4f$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ly4f;->w:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Ly4f;->x:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Ly4f;->y:Landroid/text/TextPaint;
    ...
    invoke-direct {v0, p0}, Lx4f;-><init>(Ly4f;)V
    ...
    invoke-virtual {p0, p1}, Ly4f;->onThemeChanged(Lcad;)V

    new-instance p1, Lcy8;

    invoke-direct {p1}, Lcy8;-><init>()V

    iput-object p1, p0, Ly4f;->E:Lcy8;

    return-void
.end method

.method public static synthetic l(Ly4f;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Ly4f;->r(Ly4f;)Ljava/lang/String;
...
.method private final m(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Ly4f;->n(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, v0, p1}, Ly4f;->q(ILjava/lang/Integer;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Ly4f;->o()Ljava/lang/String;
...
.method public static final r(Ly4f;)Ljava/lang/String;
    .locals 1

    iget-object p0, p0, Ly4f;->w:Landroid/content/Context;
...
.method public g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$x;)V
    ...
    invoke-direct {p0, p3, v0}, Ly4f;->n(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, v1, v0}, Ly4f;->q(ILjava/lang/Integer;)Z
    ...
    :cond_0
    invoke-virtual {p0, v1, v0}, Ly4f;->p(ILjava/lang/Integer;)Z
...
.method public i(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$x;)V
    ...
    invoke-direct {p0, p2, v1}, Ly4f;->m(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, Ly4f;->E:Lcy8;

    iget-object v4, p0, Ly4f;->x:Landroid/graphics/Rect;

    invoke-virtual {v3, v4, v0, v1}, Lcy8;->c(Landroid/graphics/Rect;Landroid/view/View;I)V

    iget-object v0, p0, Ly4f;->x:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Ly4f;->y:Landroid/text/TextPaint;
...
.method public onThemeChanged(Lcad;)V
    ...
    iget-object v2, p0, Ly4f;->y:Landroid/text/TextPaint;
    ...
    iget-object v1, p0, Ly4f;->w:Landroid/content/Context;

.class public Lru/CryptoPro/ssl/util/HostnameChecker;
...
.field private static final a:Lru/CryptoPro/ssl/util/HostnameChecker;

.field private static final b:Lru/CryptoPro/ssl/util/HostnameChecker;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lru/CryptoPro/ssl/util/HostnameChecker;

    const/4 v1, 0x1

    invoke-direct {v0, v1}, Lru/CryptoPro/ssl/util/HostnameChecker;-><init>(B)V

    sput-object v0, Lru/CryptoPro/ssl/util/HostnameChecker;->a:Lru/CryptoPro/ssl/util/HostnameChecker;
    ...
    sput-object v0, Lru/CryptoPro/ssl/util/HostnameChecker;->b:Lru/CryptoPro/ssl/util/HostnameChecker;
...
.method private constructor <init>(B)V
    ...
    iput-byte p1, p0, Lru/CryptoPro/ssl/util/HostnameChecker;->e:B
...
.method private a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 3
    invoke-static {p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->b(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-byte v0, p0, Lru/CryptoPro/ssl/util/HostnameChecker;->e:B

    const/4 v2, 0x1

    if-ne v0, v2, :cond_1

    invoke-static {p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->c(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->d(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private b(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-direct {p0, p1, v3}, Lru/CryptoPro/ssl/util/HostnameChecker;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->getSubjectX500Name(Ljava/security/cert/X509Certificate;)Lru/CryptoPro/reprov/x509/X500Name;
    ...
    invoke-direct {p0, p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static c(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v1}, Lru/CryptoPro/ssl/util/HostnameChecker;->e(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v3, v4}, Lru/CryptoPro/ssl/util/HostnameChecker;->e(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static getInstance(B)Lru/CryptoPro/ssl/util/HostnameChecker;
    .locals 3
    ...
    sget-object p0, Lru/CryptoPro/ssl/util/HostnameChecker;->a:Lru/CryptoPro/ssl/util/HostnameChecker;
    ...
    sget-object p0, Lru/CryptoPro/ssl/util/HostnameChecker;->b:Lru/CryptoPro/ssl/util/HostnameChecker;
...
.method public static getServerName(Ljava/security/Principal;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lru/CryptoPro/ssl/cl_77;->a(Ljava/security/Principal;)Ljava/lang/String;
...
.method public match(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {p1}, Lru/CryptoPro/ssl/util/HostnameChecker;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->a(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V

    return-void

    :cond_0
    invoke-direct {p0, p1, p2}, Lru/CryptoPro/ssl/util/HostnameChecker;->b(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V

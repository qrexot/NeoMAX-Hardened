.class public final Lru/CryptoPro/sspiSSL/pc_3/cl_5;
...
.field private static final v:Ljava/lang/String; = "ssl_ca"

.field private static final w:Ljava/lang/String; = "object_signing_ca"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->f:Lru/CryptoPro/reprov/array/ObjectIdentifier;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Collection;)V
    ...
    iput-object p1, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->z:Ljava/util/Collection;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->y:Ljava/util/Collection;
    ...
    invoke-static {p2, v0}, Lru/CryptoPro/sspiSSL/pc_3/cl_3;->a(Ljava/security/cert/X509Certificate;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->y:Ljava/util/Collection;

    invoke-interface {v0, p2}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    :cond_0
    iget-object v0, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->z:Ljava/util/Collection;
    ...
    iput-object p1, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->x:Ljava/util/Map;

    iget-object p1, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->y:Ljava/util/Collection;
    ...
    iget-object v1, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->x:Ljava/util/Map;
    ...
    iget-object v2, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->x:Ljava/util/Map;
...
.method private a(Ljava/security/cert/X509Certificate;I)I
    ...
    :cond_0
    invoke-direct {p0, p1, v0, p2}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->a(Ljava/security/cert/X509Certificate;Ljava/util/Set;I)I

    move-result p2

    invoke-direct {p0, p1, v0}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->b(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V

    invoke-direct {p0, p1, v0}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->a(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V
    ...
    sget-object v1, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->c:Ljava/lang/Object;

    invoke-direct {p2, v0, v1, p1}, Lru/CryptoPro/sspiSSL/pc_3/cl_7;-><init>(Ljava/lang/String;Ljava/lang/Object;Ljava/security/cert/X509Certificate;)V
...
.method private a(Ljava/security/cert/X509Certificate;Ljava/util/Set;I)I
    ...
    invoke-static {p1}, Lru/CryptoPro/sspiSSL/pc_3/cl_3;->a(Ljava/security/cert/X509Certificate;)Z
    ...
    sget-object v0, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->c:Ljava/lang/Object;

    invoke-direct {p2, p3, v0, p1}, Lru/CryptoPro/sspiSSL/pc_3/cl_7;-><init>(Ljava/lang/String;Ljava/lang/Object;Ljava/security/cert/X509Certificate;)V
...
.method private a(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V
    ...
    .line 5
    iget-object v0, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->s:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->a(Ljava/security/cert/X509Certificate;Ljava/lang/String;)Z
...
.method public static a(Ljava/security/cert/X509Certificate;Ljava/lang/String;)Z
    ...
    sget-object v0, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->f:Lru/CryptoPro/reprov/array/ObjectIdentifier;
...
.method private b([Ljava/security/cert/X509Certificate;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0, v2}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->a(Ljava/security/cert/X509Certificate;)Ljava/security/cert/X509Certificate;
    ...
    sget-object p1, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->g:[Ljava/security/cert/X509Certificate;
    ...
    sget-object v0, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->a:Ljava/lang/Object;

    invoke-direct {p1, v0}, Lru/CryptoPro/sspiSSL/pc_3/cl_7;-><init>(Ljava/lang/Object;)V
...
.method public a([Ljava/security/cert/X509Certificate;Ljava/util/Collection;Ljava/security/AlgorithmConstraints;Ljava/lang/Object;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0, p1}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->b([Ljava/security/cert/X509Certificate;)[Ljava/security/cert/X509Certificate;

    move-result-object p1

    iget-object p2, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->u:Ljava/util/Date;
    ...
    new-instance p4, Lru/CryptoPro/sspiSSL/pc_1/cl_0;

    iget-object v2, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->s:Ljava/lang/String;

    invoke-direct {p4, v1, v2}, Lru/CryptoPro/sspiSSL/pc_1/cl_0;-><init>(Ljava/security/cert/TrustAnchor;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->s:Ljava/lang/String;
    ...
    invoke-virtual {p4, v3, v4}, Lru/CryptoPro/sspiSSL/pc_1/cl_0;->check(Ljava/security/cert/Certificate;Ljava/util/Collection;)V

    if-eqz v0, :cond_2

    invoke-virtual {v0, v3, v4}, Lru/CryptoPro/sspiSSL/pc_1/cl_0;->check(Ljava/security/cert/Certificate;Ljava/util/Collection;)V
    :try_end_0
    ...
    :cond_2
    :goto_1
    iget-object v4, p0, Lru/CryptoPro/sspiSSL/pc_3/cl_6;->s:Ljava/lang/String;
    ...
    invoke-direct {p0, v3, p3}, Lru/CryptoPro/sspiSSL/pc_3/cl_5;->a(Ljava/security/cert/X509Certificate;I)I
    ...
    sget-object p3, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->e:Ljava/lang/Object;

    invoke-direct {p2, p3, v3, p1}, Lru/CryptoPro/sspiSSL/pc_3/cl_7;-><init>(Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/lang/Throwable;)V
    ...
    sget-object p2, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->f:Ljava/lang/Object;

    invoke-direct {p1, p2, v3}, Lru/CryptoPro/sspiSSL/pc_3/cl_7;-><init>(Ljava/lang/Object;Ljava/security/cert/X509Certificate;)V
    ...
    sget-object p3, Lru/CryptoPro/sspiSSL/pc_3/cl_7;->g:Ljava/lang/Object;

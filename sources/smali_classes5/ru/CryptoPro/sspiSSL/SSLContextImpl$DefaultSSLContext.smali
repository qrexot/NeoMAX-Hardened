.class public final Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;
.super Lru/CryptoPro/sspiSSL/SSLContextImpl$CustomizedSSLContext;
...
.field private static volatile c:Lru/CryptoPro/sspiSSL/SSLContextImpl;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lru/CryptoPro/sspiSSL/SSLContextImpl$CustomizedSSLContext;-><init>()V

    :try_start_0
    invoke-static {}, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->n()[Ljavax/net/ssl/KeyManager;

    move-result-object v0

    invoke-static {}, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->m()[Ljavax/net/ssl/TrustManager;

    move-result-object v1

    const/4 v2, 0x0

    invoke-super {p0, v0, v1, v2}, Lru/CryptoPro/sspiSSL/SSLContextImpl;->engineInit([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    sget-object v0, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->c:Lru/CryptoPro/sspiSSL/SSLContextImpl;

    if-nez v0, :cond_0

    sput-object p0, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->c:Lru/CryptoPro/sspiSSL/SSLContextImpl;
...
.method public static declared-synchronized l()Lru/CryptoPro/sspiSSL/SSLContextImpl;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    const-class v0, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->c:Lru/CryptoPro/sspiSSL/SSLContextImpl;

    if-nez v1, :cond_0

    new-instance v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;

    invoke-direct {v1}, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;-><init>()V
...
.method private static declared-synchronized m()[Ljavax/net/ssl/TrustManager;
    ...
    :try_start_0
    sget-object v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->d:[Ljavax/net/ssl/TrustManager;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-object v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->d:[Ljavax/net/ssl/TrustManager;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private static declared-synchronized n()[Ljavax/net/ssl/KeyManager;
    ...
    :try_start_0
    sget-object v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->e:[Ljavax/net/ssl/KeyManager;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    new-instance v5, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext$1;

    invoke-direct {v5, v2}, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext$1;-><init>(Ljava/lang/String;)V
    ...
    :cond_b
    invoke-static {}, Lru/CryptoPro/sspiSSL/SSLContextImpl;->k()Z
    ...
    sput-object v1, Lru/CryptoPro/sspiSSL/SSLContextImpl$DefaultSSLContext;->e:[Ljavax/net/ssl/KeyManager;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

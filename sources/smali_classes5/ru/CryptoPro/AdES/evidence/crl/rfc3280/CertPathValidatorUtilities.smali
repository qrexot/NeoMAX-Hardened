.class Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;
...
.field protected static final CRL_UTIL:Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;

    invoke-direct {v0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;-><init>()V

    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CRL_UTIL:Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->POLICY_MAPPINGS:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->NAME_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->KEY_USAGE:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->INHIBIT_ANY_POLICY:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->DELTA_CRL_INDICATOR:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->FRESHEST_CRL:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CRL_DISTRIBUTION_POINTS:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->AUTHORITY_KEY_IDENTIFIER:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CRL_NUMBER:Ljava/lang/String;
    ...
    sput-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->crlReasons:[Ljava/lang/String;
...
.method public static checkCRLsNotEmpty(Ljava/util/Set;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/X500Name;
...
.method public static findIssuerCerts(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_start_0
    invoke-static {p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    sget-object v1, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->AUTHORITY_KEY_IDENTIFIER:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->findCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;

    move-result-object p1

    invoke-interface {v1, p1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    invoke-static {p0, p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->findCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
...
.method public static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-static {p0, p1, v0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method public static findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-static {p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    invoke-static {v3}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getCA(Ljava/security/cert/TrustAnchor;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_2
    invoke-static {p0, v5, p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->verifyX509Certificate(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_2
...
.method public static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertStatus;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getSerialNumber(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :goto_0
    invoke-static {p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    invoke-static {v0, p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :goto_3
    invoke-virtual {p3, p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertStatus;->setCertStatus(I)V
    ...
    invoke-virtual {p3, p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertStatus;->setRevocationDate(Ljava/util/Date;)V
...
.method public static getCompleteCRLs(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object v2

    invoke-interface {v1, v2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    invoke-static {p0, v1, v0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getCRLIssuersFromDistributionPoint(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    ...
    :cond_1
    sget-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CRL_UTIL:Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;
    ...
    invoke-virtual {v0, p0, p2, v1, p3}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p0, p1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->checkCRLsNotEmpty(Ljava/util/Set;Ljava/lang/Object;)V
...
.method public static getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    :try_start_1
    sget-object v1, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CRL_NUMBER:Ljava/lang/String;

    invoke-static {p1, v1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :goto_0
    :try_start_2
    sget-object v3, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p0, p2, p3}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->isDeltaCRL(Ljava/security/cert/X509CRL;)Z
...
.method public static getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :cond_0
    invoke-static {p1, p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getObject(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method public static getValidCertDateFromValidityModel(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    invoke-static {p0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getValidDate(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
...
.method private static isDeltaCRL(Ljava/security/cert/X509CRL;)Z
    ...
    :cond_0
    sget-object v0, Lru/CryptoPro/AdES/evidence/crl/rfc3280/RFC3280CRLUtility;->DELTA_CRL_INDICATOR:Ljava/lang/String;
...
.method public static isIssuerTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->findTrustAnchor(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method public static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    :try_start_0
    sget-object v1, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;

    invoke-static {p4, v1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v1}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->getQualifierSet(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    sget-object v3, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;
...
.method public static prepareNextCertB2(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {p3, p1, v4}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->removePolicyNode(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method public static removePolicyNode(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {p1, p2}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->removePolicyNodeRecurse([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
...
.method private static removePolicyNodeRecurse([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-static {p0, v0}, Lru/CryptoPro/AdES/evidence/crl/rfc3280/CertPathValidatorUtilities;->removePolicyNodeRecurse([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

.class public Lru/CryptoPro/reprov/x509/EDIPartyName;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;

    const/4 v0, -0x1

    iput v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->myhash:I

    iput-object p1, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;

    iput-object p2, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
...
.method public constructor <init>(Lru/CryptoPro/reprov/array/DerValue;)V
    ...
    iput-object v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
    ...
    invoke-virtual {v4, p1}, Lru/CryptoPro/reprov/array/DerValue;->isContextSpecific(B)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {v4}, Lru/CryptoPro/reprov/array/DerValue;->isConstructed()Z

    move-result v5

    if-nez v5, :cond_1

    iget-object v5, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
    ...
    iput-object v5, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    invoke-virtual {v4, v2}, Lru/CryptoPro/reprov/array/DerValue;->isContextSpecific(B)Z
    ...
    iget-object v5, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
    ...
    iput-object v4, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
...
.method public encode(Lru/CryptoPro/reprov/array/DerOutputStream;)V
    ...
    iget-object v2, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
    ...
    invoke-virtual {v2, v5}, Lru/CryptoPro/reprov/array/DerOutputStream;->putPrintableString(Ljava/lang/String;)V

    invoke-static {v3, v4, v4}, Lru/CryptoPro/reprov/array/DerValue;->createTag(BZB)B

    move-result v5

    invoke-virtual {v0, v5, v2}, Lru/CryptoPro/reprov/array/DerOutputStream;->write(BLru/CryptoPro/reprov/array/DerOutputStream;)V

    :cond_0
    iget-object v2, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;

    if-eqz v2, :cond_1

    invoke-virtual {v1, v2}, Lru/CryptoPro/reprov/array/DerOutputStream;->putPrintableString(Ljava/lang/String;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Lru/CryptoPro/reprov/x509/EDIPartyName;
    ...
    :cond_0
    check-cast p1, Lru/CryptoPro/reprov/x509/EDIPartyName;

    iget-object v0, p1, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
    ...
    :cond_2
    iget-object p1, p1, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;

    iget-object v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;
...
.method public getAssignerName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
...
.method public hashCode()I
    ...
    iget v0, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->myhash:I
    ...
    iget-object v1, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->assigner:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lru/CryptoPro/reprov/x509/EDIPartyName;->party:Ljava/lang/String;

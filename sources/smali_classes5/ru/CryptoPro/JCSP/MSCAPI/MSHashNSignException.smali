.class public Lru/CryptoPro/JCSP/MSCAPI/MSHashNSignException;
...
.method public static procCode(I)V
    ...
    const-string v0, "Hash or Sign"

    sparse-switch p0, :sswitch_data_0

    invoke-static {p0}, Lru/CryptoPro/JCSP/MSCAPI/MSException;->isNetworkError(I)Z
    ...
    :cond_0
    new-instance v1, Lru/CryptoPro/JCSP/MSCAPI/MSHsmChannelClosedException;

    invoke-static {p0, v0}, Lru/CryptoPro/JCSP/MSCAPI/MSException;->formatErrorMessage(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-direct {v1, p0}, Lru/CryptoPro/JCSP/MSCAPI/MSHsmChannelClosedException;-><init>(Ljava/lang/String;)V
    ...
    .sparse-switch
        ...
        -0x7ff6fffc -> :sswitch_1
        -0x7ff6fffa -> :sswitch_1
        -0x7ff6fff8 -> :sswitch_2
        -0x7ff6fff7 -> :sswitch_2
        -0x7ff6fff4 -> :sswitch_1
        -0x7ff6fff3 -> :sswitch_1
        -0x7ff6ffea -> :sswitch_1
        -0x7ff6ffe7 -> :sswitch_1
        -0x7ff6ffe0 -> :sswitch_1
        -0x7ff6ffde -> :sswitch_1
        -0x7fefffd6 -> :sswitch_1
        -0x7fefff97 -> :sswitch_1
        -0x7fefff95 -> :sswitch_1
        -0x7fefff94 -> :sswitch_1
        -0x7fefff92 -> :sswitch_1
        0x57 -> :sswitch_2
        0x78 -> :sswitch_1
        0xea -> :sswitch_1
    .end sparse-switch
...
# virtual methods
.method public isBadSignature()Z
    .locals 2

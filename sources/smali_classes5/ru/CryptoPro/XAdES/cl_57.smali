...
# direct methods
.method public constructor <init>(Lorg/w3c/dom/Document;Lru/CryptoPro/XAdES/cl_51;Lru/CryptoPro/XAdES/cl_56;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7
    ...
    iput-object p1, v0, Lru/CryptoPro/XAdES/cl_57;->a:Lorg/bouncycastle/asn1/ess/OtherCertID;
    ...
    invoke-interface {p3}, Lru/CryptoPro/XAdES/cl_56;->a()Ljava/lang/String;
    ...
    invoke-interface {p3}, Lru/CryptoPro/XAdES/cl_56;->b()Ljava/lang/String;
    ...
    invoke-interface {p3}, Lru/CryptoPro/XAdES/cl_56;->c()[B
    ...
    invoke-virtual {p0}, Lru/CryptoPro/XAdES/cl_57;->getNode()Lorg/w3c/dom/Node;

    move-result-object p1

    invoke-interface {p1, p2}, Lorg/w3c/dom/Node;->appendChild(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;

    invoke-direct {p0, p3}, Lru/CryptoPro/XAdES/cl_57;->a(Lru/CryptoPro/XAdES/cl_56;)V
...
.method public constructor <init>(Lorg/w3c/dom/Node;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lru/CryptoPro/XAdES/cl_57;->a:Lorg/bouncycastle/asn1/ess/OtherCertID;

    invoke-direct {p0, p1}, Lru/CryptoPro/XAdES/cl_57;->a(Lru/CryptoPro/XAdES/cl_56;)V

    return-void
.end method

.method private a(Lru/CryptoPro/XAdES/cl_56;)V
    .locals 4

    .line 2
    invoke-static {}, Lru/CryptoPro/JCP/tools/JCPLogger;->subEnter()V

    iget-object v0, p0, Lru/CryptoPro/XAdES/cl_57;->a:Lorg/bouncycastle/asn1/ess/OtherCertID;

    if-nez v0, :cond_2

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lru/CryptoPro/XAdES/cl_56;->a()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lru/CryptoPro/XAdES/cl_56;->c()[B
    ...
    invoke-direct {p0}, Lru/CryptoPro/XAdES/cl_57;->c()[B
    ...
    iput-object v1, p0, Lru/CryptoPro/XAdES/cl_57;->a:Lorg/bouncycastle/asn1/ess/OtherCertID;
    :try_end_0

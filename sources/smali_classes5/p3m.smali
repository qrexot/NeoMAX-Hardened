...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lx3m;

    invoke-direct {v1}, Lx3m;-><init>()V
    ...
    sput-object v0, Lp3m;->d:Ljava/security/AlgorithmConstraints;
    ...
    invoke-direct {v1, v2}, Lx3m;-><init>(Z)V

    const-string v2, "jdk.certpath.disabledAlgorithms"

    invoke-direct {v0, v2, v1}, Lru/CryptoPro/ssl/util/DisabledAlgorithmConstraints;-><init>(Ljava/lang/String;Lru/CryptoPro/ssl/util/AlgorithmDecomposer;)V

    sput-object v0, Lp3m;->e:Ljava/security/AlgorithmConstraints;

    new-instance v0, Lp3m;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lp3m;-><init>(Ljava/security/AlgorithmConstraints;)V

    sput-object v0, Lp3m;->f:Ljava/security/AlgorithmConstraints;

    new-instance v0, Lp3m;

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lp3m;-><init>(Ljavax/net/ssl/SSLSocket;Z)V

    sput-object v0, Lp3m;->g:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljava/security/AlgorithmConstraints;)V
    ...
    iput-object v0, p0, Lp3m;->b:Ljava/security/AlgorithmConstraints;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lp3m;->c:Z

    iput-object p1, p0, Lp3m;->a:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljavax/net/ssl/SSLEngine;Z)V
    ...
    iput-object v0, p0, Lp3m;->a:Ljava/security/AlgorithmConstraints;
...
.method public constructor <init>(Ljavax/net/ssl/SSLEngine;[Ljava/lang/String;Z)V
    ...
    new-instance p1, Lu3m;

    invoke-direct {p1, p2}, Lu3m;-><init>([Ljava/lang/String;)V

    iput-object p1, p0, Lp3m;->b:Ljava/security/AlgorithmConstraints;
...
.method public permits(Ljava/util/Set;Ljava/lang/String;Ljava/security/AlgorithmParameters;)Z
    ...
    .line 1
    iget-object v0, p0, Lp3m;->b:Ljava/security/AlgorithmConstraints;
    ...
    iget-object v1, p0, Lp3m;->a:Ljava/security/AlgorithmConstraints;
    ...
    sget-object v0, Lp3m;->d:Ljava/security/AlgorithmConstraints;
    ...
    iget-boolean v1, p0, Lp3m;->c:Z

    if-eqz v1, :cond_3

    sget-object v0, Lp3m;->e:Ljava/security/AlgorithmConstraints;

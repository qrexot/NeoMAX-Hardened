...
# static fields
.field public static final b:Ljava/lang/String; = "dg8"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldg8;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x0

    sput-boolean v0, Ldg8;->d:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Lcg8;-><init>(Landroid/content/Context;)V

    invoke-static {v0}, Lja9;->a(Lgr7;)Lz99;

    move-result-object p1

    iput-object p1, p0, Ldg8;->a:Lz99;
...
.method public b(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    sget-boolean v0, Ldg8;->d:Z

    if-eqz v0, :cond_0

    invoke-static {p1, p2, p3}, Ldg8;->i(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Ldg8;->h()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1, p2, p3}, Ldg8;->c(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Ldg8;->j(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    :goto_0
    sget-object v1, Ldg8;->b:Ljava/lang/String;
...
.method public final c(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Ldg8;->b:Ljava/lang/String;
    ...
    invoke-static {v2, v3, p3}, Lzl9;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final h()Z
    ...
    sget-object v0, Ldg8;->c:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final j(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    .locals 6

    const/4 v0, 0x0

    :try_start_0
    invoke-virtual {p0}, Ldg8;->g()Landroid/renderscript/RenderScript;
    ...
    invoke-static {v2}, Ldg8;->e(Landroid/renderscript/Allocation;)V

    invoke-static {v4}, Ldg8;->e(Landroid/renderscript/Allocation;)V

    invoke-static {v0}, Ldg8;->f(Landroid/renderscript/BaseObj;)V

    invoke-static {v3}, Ldg8;->f(Landroid/renderscript/BaseObj;)V
    ...
    :goto_1
    invoke-static {v0}, Ldg8;->e(Landroid/renderscript/Allocation;)V

    invoke-static {v4}, Ldg8;->e(Landroid/renderscript/Allocation;)V

    invoke-static {p2}, Ldg8;->f(Landroid/renderscript/BaseObj;)V

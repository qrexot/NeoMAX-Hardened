...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lel7$c;->d:Lel7$c;

    sput-object v0, Lel7;->b:Lel7$c;
...
.method public static synthetic a(Ljava/lang/String;Landroidx/fragment/app/strictmode/Violation;)V
    ...
    invoke-static {p0, p1}, Lel7;->d(Ljava/lang/String;Landroidx/fragment/app/strictmode/Violation;)V
...
.method public static final f(Landroidx/fragment/app/Fragment;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lel7;->e(Landroidx/fragment/app/strictmode/Violation;)V

    invoke-virtual {p1, p0}, Lel7;->b(Landroidx/fragment/app/Fragment;)Lel7$c;

    move-result-object v1

    invoke-virtual {v1}, Lel7$c;->a()Ljava/util/Set;

    move-result-object v2

    sget-object v3, Lel7$a;->DETECT_FRAGMENT_REUSE:Lel7$a;
    ...
    invoke-virtual {p1, v1, p0, v2}, Lel7;->q(Lel7$c;Ljava/lang/Class;Ljava/lang/Class;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-virtual {p1, v1, v0}, Lel7;->c(Lel7$c;Landroidx/fragment/app/strictmode/Violation;)V
...
.method public static final h(Landroidx/fragment/app/Fragment;)V
    ...
    sget-object v1, Lel7;->a:Lel7;

    invoke-virtual {v1, v0}, Lel7;->e(Landroidx/fragment/app/strictmode/Violation;)V

    invoke-virtual {v1, p0}, Lel7;->b(Landroidx/fragment/app/Fragment;)Lel7$c;

    move-result-object v2

    invoke-virtual {v2}, Lel7$c;->a()Ljava/util/Set;

    move-result-object v3

    sget-object v4, Lel7$a;->DETECT_RETAIN_INSTANCE_USAGE:Lel7$a;
    ...
    invoke-virtual {v1, v2, p0, v3}, Lel7;->q(Lel7$c;Ljava/lang/Class;Ljava/lang/Class;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-virtual {v1, v2, v0}, Lel7;->c(Lel7$c;Landroidx/fragment/app/strictmode/Violation;)V
...
.method public static final i(Landroidx/fragment/app/Fragment;)V
    ...
    sget-object v4, Lel7$a;->DETECT_TARGET_FRAGMENT_USAGE:Lel7$a;
...
.method public static final l(Landroidx/fragment/app/Fragment;Landroidx/fragment/app/Fragment;I)V
    ...
    invoke-virtual {p2}, Lel7$c;->a()Ljava/util/Set;

    move-result-object v1

    sget-object v2, Lel7$a;->DETECT_TARGET_FRAGMENT_USAGE:Lel7$a;
    ...
    invoke-virtual {p1, p2, p0, v1}, Lel7;->q(Lel7$c;Ljava/lang/Class;Ljava/lang/Class;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-virtual {p1, p2, v0}, Lel7;->c(Lel7$c;Landroidx/fragment/app/strictmode/Violation;)V
...
.method public static final m(Landroidx/fragment/app/Fragment;Z)V
    ...
    sget-object v3, Lel7$a;->DETECT_SET_USER_VISIBLE_HINT:Lel7$a;
...
.method public static final n(Landroidx/fragment/app/Fragment;Landroid/view/ViewGroup;)V
    ...
    sget-object v3, Lel7$a;->DETECT_WRONG_FRAGMENT_CONTAINER:Lel7$a;
...
.method public static final o(Landroidx/fragment/app/Fragment;Landroidx/fragment/app/Fragment;I)V
    ...
    sget-object v2, Lel7$a;->DETECT_WRONG_NESTED_HIERARCHY:Lel7$a;
...
# virtual methods
.method public final b(Landroidx/fragment/app/Fragment;)Lel7$c;
    .locals 2
    ...
    invoke-virtual {v0}, Landroidx/fragment/app/FragmentManager;->K0()Lel7$c;
    ...
    :cond_1
    sget-object p1, Lel7;->b:Lel7$c;

    return-object p1
.end method

.method public final c(Lel7$c;Landroidx/fragment/app/strictmode/Violation;)V
    .locals 4
    ...
    invoke-virtual {p1}, Lel7$c;->a()Ljava/util/Set;

    move-result-object v2

    sget-object v3, Lel7$a;->PENALTY_LOG:Lel7$a;
    ...
    :cond_0
    invoke-virtual {p1}, Lel7$c;->b()Lel7$b;

    invoke-virtual {p1}, Lel7$c;->a()Ljava/util/Set;

    move-result-object p1

    sget-object v2, Lel7$a;->PENALTY_DEATH:Lel7$a;
    ...
    invoke-direct {p1, v1, p2}, Ldl7;-><init>(Ljava/lang/String;Landroidx/fragment/app/strictmode/Violation;)V

    invoke-virtual {p0, v0, p1}, Lel7;->p(Landroidx/fragment/app/Fragment;Ljava/lang/Runnable;)V
...
.method public final p(Landroidx/fragment/app/Fragment;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1}, Landroidx/fragment/app/FragmentManager;->E0()Lrk7;
...
.method public final q(Lel7$c;Ljava/lang/Class;Ljava/lang/Class;)Z
    .locals 2
    ...
    invoke-virtual {p1}, Lel7$c;->c()Ljava/util/Map;
    ...
    invoke-static {p1, v0}, Lqn3;->i0(Ljava/lang/Iterable;Ljava/lang/Object;)Z

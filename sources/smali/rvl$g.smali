...
.method public constructor <init>(Lrvl;Lneg;)V
    ...
    iput-object p1, p0, Lrvl$g;->d:Lrvl;

    invoke-direct {p0, p2}, Lzd6;-><init>(Lneg;)V
...
.method public bridge synthetic j(Lu6j;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lrvl$g;->l(Lu6j;Lpvl;)V
...
.method public l(Lu6j;Lpvl;)V
    ...
    invoke-static {v9}, Lxvl;->g(Lb5c;)I

    move-result v9

    int-to-long v9, v9

    invoke-interface {p1, v7, v9, v10}, Lr6j;->b(IJ)V
    ...
    invoke-interface {p1, v6, v9, v10}, Lr6j;->b(IJ)V
    ...
    invoke-interface {p1, v5, v6, v7}, Lr6j;->b(IJ)V
    ...
    invoke-static {v0}, Lxvl;->i(Ljava/util/Set;)[B

    move-result-object v0

    if-nez v0, :cond_5

    invoke-interface {p1, v8}, Lr6j;->e(I)V

    goto :goto_5

    :cond_5
    invoke-interface {p1, v8, v0}, Lr6j;->c(I[B)V
    ...
    :goto_5
    iget-object p2, p2, Lpvl;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-interface {p1, v0, p2}, Lr6j;->p(ILjava/lang/String;)V

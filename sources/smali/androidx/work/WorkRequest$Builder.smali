...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "setBackoffCriteria",
        "(Lti0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;",
        "Ljava/time/Duration;",
        "duration",
        "(Lti0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;",
        "Lh34;",
        "constraints",
        "setConstraints",
        "(Lh34;)Landroidx/work/WorkRequest$Builder;",
        "Landroidx/work/b;",
        "inputData",
        "setInputData",
        ...
        "policy",
        "setExpedited",
        "(Lyid;)Landroidx/work/WorkRequest$Builder;",
        "build",
        "()Landroidx/work/WorkRequest;",
        ...
        "state",
        "setInitialState",
        "(Lnul$a;)Landroidx/work/WorkRequest$Builder;",
        "",
        "runAttemptCount",
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    invoke-direct {v0, v1, v2}, Lpvl;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;
    ...
    invoke-static {p1}, Llkh;->h([Ljava/lang/Object;)Ljava/util/Set;
...
.method public final build()Landroidx/work/WorkRequest;
    ...
    iget-object v1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;

    iget-object v1, v1, Lpvl;->j:Lh34;

    invoke-virtual {v1}, Lh34;->e()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Lh34;->f()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Lh34;->g()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Lh34;->h()Z
    ...
    :goto_1
    iget-object v2, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;

    iget-boolean v3, v2, Lpvl;->q:Z

    if-eqz v3, :cond_4

    if-nez v1, :cond_3

    iget-wide v1, v2, Lpvl;->g:J
...
.method public final getWorkSpec$work_runtime_release()Lpvl;
    .locals 1

    iget-object v0, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;
...
.method public final keepResultsForAtLeast(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-static {p1}, Li16;->a(Ljava/time/Duration;)J

    move-result-wide v1

    iput-wide v1, v0, Lpvl;->o:J
...
.method public final setBackoffCriteria(Lti0;JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lpvl;->k(J)V
...
.method public final setBackoffCriteria(Lti0;Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p2}, Li16;->a(Ljava/time/Duration;)J
...
.method public final setConstraints(Lh34;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setExpedited(Lyid;)Landroidx/work/WorkRequest$Builder;
    .locals 2
    ...
    iput-boolean v1, v0, Lpvl;->q:Z

    iput-object p1, v0, Lpvl;->r:Lyid;
...
.method public final setId(Ljava/util/UUID;)Landroidx/work/WorkRequest$Builder;
    ...
    invoke-direct {v0, p1, v1}, Lpvl;-><init>(Ljava/lang/String;Lpvl;)V
...
.method public setInitialDelay(JLjava/util/concurrent/TimeUnit;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p3, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;

    iget-wide v0, p3, Lpvl;->g:J
...
.method public setInitialDelay(Ljava/time/Duration;)Landroidx/work/WorkRequest$Builder;
    ...
    iget-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;

    iget-wide v2, p1, Lpvl;->g:J
...
.method public final setInitialState(Lnul$a;)Landroidx/work/WorkRequest$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, v0, Lpvl;->b:Lnul$a;
...
.method public final setInputData(Landroidx/work/b;)Landroidx/work/WorkRequest$Builder;
    ...
    iput-object p1, v0, Lpvl;->e:Landroidx/work/b;
...
.method public final setWorkSpec$work_runtime_release(Lpvl;)V
    .locals 0

    iput-object p1, p0, Landroidx/work/WorkRequest$Builder;->workSpec:Lpvl;

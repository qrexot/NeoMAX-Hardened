...
.field private final mStartStopTokens:Lgji;

.field private mWorkManagerImpl:Lvul;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Lgji;

    return-void
.end method

.method private static workGenerationalIdFromJobParameters(Landroid/app/job/JobParameters;)Lmul;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lmul;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkManagerImpl:Lvul;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkManagerImpl:Lvul;
...
.method public onExecuted(Lmul;Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Lgji;

    invoke-virtual {v0, p1}, Lgji;->b(Lmul;)Lfji;
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->workGenerationalIdFromJobParameters(Landroid/app/job/JobParameters;)Lmul;
    ...
    invoke-virtual {p1, v1, v0}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4, v5}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_5
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkManagerImpl:Lvul;

    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Lgji;

    invoke-virtual {v2, v0}, Lgji;->d(Lmul;)Lfji;

    move-result-object v0

    invoke-virtual {p1, v0, v3}, Lvul;->D(Lfji;Landroidx/work/WorkerParameters$a;)V
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p1, v0, v2}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkManagerImpl:Lvul;

    invoke-virtual {v2, v0}, Lvul;->F(Lfji;)V
    ...
    invoke-virtual {v0, p1}, Lyqe;->i(Ljava/lang/String;)Z

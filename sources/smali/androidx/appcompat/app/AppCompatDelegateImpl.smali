...
.field private static final sLocalNightModes:Lk3i;
...
.field final mAppCompatCallback:Lis;
...
.field private mDecorContentParent:Laz4;
...
.field private mLayoutIncludeDetector:Lv99;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Lk3i;
...
.method public constructor <init>(Landroid/app/Activity;Lis;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, v0, p2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;-><init>(Landroid/content/Context;Landroid/view/Window;Lis;Ljava/lang/Object;)V

    return-void
.end method

.method public constructor <init>(Landroid/app/Dialog;Lis;)V
    .locals 2
    ...
    invoke-direct {p0, v0, v1, p2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;-><init>(Landroid/content/Context;Landroid/view/Window;Lis;Ljava/lang/Object;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/app/Activity;Lis;)V
    .locals 1

    const/4 v0, 0x0

    .line 4
    invoke-direct {p0, p1, v0, p3, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;-><init>(Landroid/content/Context;Landroid/view/Window;Lis;Ljava/lang/Object;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;Lis;)V
    .locals 0

    .line 3
    invoke-direct {p0, p1, p2, p3, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;-><init>(Landroid/content/Context;Landroid/view/Window;Lis;Ljava/lang/Object;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Landroid/view/Window;Lis;Ljava/lang/Object;)V
    .locals 2
    ...
    .line 11
    iput-object p3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAppCompatCallback:Lis;
    ...
    .line 17
    sget-object p1, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Lk3i;
    ...
    invoke-virtual {p1, p3}, Lk3i;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p3}, Lk3i;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private applyApplicationSpecificConfig(ZZ)Z
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->calculateApplicationLocales(Landroid/content/Context;)Lok9;
    ...
    .line 10
    invoke-virtual {p0, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Lok9;

    move-result-object v2

    .line 11
    :cond_2
    invoke-direct {p0, v1, v2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->updateAppConfiguration(ILok9;Z)Z
...
.method private applyFixedSizeWindow()V
    ...
    sget-object v2, Lrof;->AppCompatTheme:[I

    invoke-virtual {v1, v2}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Lrof;->AppCompatTheme_windowMinWidthMajor:I
    ...
    sget v2, Lrof;->AppCompatTheme_windowMinWidthMinor:I
    ...
    sget v2, Lrof;->AppCompatTheme_windowFixedWidthMajor:I
    ...
    :cond_0
    sget v2, Lrof;->AppCompatTheme_windowFixedWidthMinor:I
    ...
    :cond_1
    sget v2, Lrof;->AppCompatTheme_windowFixedHeightMajor:I
    ...
    :cond_2
    sget v2, Lrof;->AppCompatTheme_windowFixedHeightMinor:I
...
.method private attachToWindow(Landroid/view/Window;)V
    ...
    invoke-static {v0, v2, v1}, Lhwj;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lhwj;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lhwj;->h(I)Landroid/graphics/drawable/Drawable;
...
.method private createOverrideAppConfiguration(Landroid/content/Context;ILok9;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    .locals 1
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setConfigurationLocales(Landroid/content/res/Configuration;Lok9;)V
...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    sget-object v1, Lrof;->AppCompatTheme:[I

    invoke-virtual {v0, v1}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Lrof;->AppCompatTheme_windowActionBar:I
    ...
    sget v1, Lrof;->AppCompatTheme_windowNoTitle:I
    ...
    :cond_1
    :goto_0
    sget v1, Lrof;->AppCompatTheme_windowActionBarOverlay:I
    ...
    :cond_2
    sget v1, Lrof;->AppCompatTheme_windowActionModeOverlay:I
    ...
    :cond_3
    sget v1, Lrof;->AppCompatTheme_android_windowIsFloating:I
    ...
    sget v1, Lxif;->abc_dialog_title_material:I
    ...
    sget v1, Lxif;->abc_screen_toolbar:I
    ...
    sget v1, Lref;->decor_content_parent:I
    ...
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;

    invoke-virtual {p0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getWindowCallback()Landroid/view/Window$Callback;

    move-result-object v3

    invoke-interface {v1, v3}, Laz4;->setWindowCallback(Landroid/view/Window$Callback;)V

    iget-boolean v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mOverlayActionBar:Z

    if-eqz v1, :cond_6

    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;

    invoke-interface {v1, v4}, Laz4;->initFeature(I)V
    ...
    invoke-interface {v1, v3}, Laz4;->initFeature(I)V
    ...
    sget v1, Lxif;->abc_screen_simple_overlay_action_mode:I
    ...
    :cond_a
    sget v1, Lxif;->abc_screen_simple:I
    ...
    :cond_c
    invoke-static {v0}, Lxal;->c(Landroid/view/View;)V

    sget v1, Lref;->action_bar_activity_content:I
...
.method private ensureSubDecor()V
    ...
    invoke-interface {v1, v0}, Laz4;->setWindowTitle(Ljava/lang/CharSequence;)V
...
.method private getAutoTimeNightModeManager(Landroid/content/Context;)Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    .line 4
    invoke-static {p1}, Lbbk;->a(Landroid/content/Context;)Lbbk;

    move-result-object p1

    invoke-direct {v0, p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$o;-><init>(Landroidx/appcompat/app/AppCompatDelegateImpl;Lbbk;)V
...
.method private initializePanelMenu(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;)Z
    ...
    sget v5, Ljbf;->actionBarWidgetTheme:I
    ...
    :cond_1
    sget v4, Ljbf;->actionBarWidgetTheme:I
...
.method private onKeyUpPanel(ILandroid/view/KeyEvent;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;

    if-eqz p1, :cond_2

    invoke-interface {p1}, Laz4;->canShowOverflowMenu()Z
    ...
    invoke-interface {p1}, Laz4;->isOverflowMenuShowing()Z
    ...
    invoke-interface {p1}, Laz4;->showOverflowMenu()Z
    ...
    invoke-interface {p1}, Laz4;->hideOverflowMenu()Z
...
.method private performPanelShortcut(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;
...
.method private preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;

    if-eqz v4, :cond_6

    invoke-interface {v4}, Laz4;->setMenuPrepared()V
    ...
    invoke-interface {v4, v6, v7}, Laz4;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
    ...
    invoke-interface {p1, v5, p2}, Laz4;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
    ...
    iget-object p2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;
    ...
    invoke-interface {p2, v5, v0}, Laz4;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/c$a;)V
...
.method private reopenMenu(Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;
    ...
    invoke-interface {v0}, Laz4;->canShowOverflowMenu()Z
    ...
    invoke-interface {v0}, Laz4;->isOverflowMenuShowPending()Z
    ...
    iget-object v3, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Laz4;

    invoke-interface {v3}, Laz4;->isOverflowMenuShowing()Z
...
.method private updateAppConfiguration(ILok9;Z)Z
    .locals 10
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILok9;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Lok9;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Lok9;
    ...
    invoke-virtual {v1, v7}, Lok9;->equals(Ljava/lang/Object;)Z
    ...
    :cond_7
    invoke-direct {p0, v5, v7, v8, v6}, Landroidx/appcompat/app/AppCompatDelegateImpl;->updateResourcesConfiguration(ILok9;ZLandroid/content/res/Configuration;)V
    ...
    invoke-virtual {p1, v3}, Landroidx/appcompat/app/AppCompatActivity;->onLocalesChanged(Lok9;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setDefaultLocalesForLocaleList(Lok9;)V

    :cond_b
    return v9
.end method

.method private updateResourcesConfiguration(ILok9;ZLandroid/content/res/Configuration;)V
    .locals 3
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setConfigurationLocales(Landroid/content/res/Configuration;Lok9;)V
...
.method private updateStatusGuardColor(Landroid/view/View;)V
    ...
    sget v1, Lzbf;->abc_decor_view_status_guard_light:I

    invoke-static {v0, v1}, Lgg4;->c(Landroid/content/Context;I)I
    ...
    sget v1, Lzbf;->abc_decor_view_status_guard:I
...
.method public applyAppLocales()Z
    ...
    invoke-static {}, Landroidx/appcompat/app/b;->getRequestedAppLocales()Lok9;
    ...
    invoke-static {}, Landroidx/appcompat/app/b;->getStoredAppLocales()Lok9;

    move-result-object v1

    invoke-virtual {v0, v1}, Lok9;->equals(Ljava/lang/Object;)Z
...
.method public attachBaseContext2(Landroid/content/Context;)Landroid/content/Context;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->calculateApplicationLocales(Landroid/content/Context;)Lok9;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILok9;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    sget v3, Lpnf;->Theme_AppCompat_Empty:I
    ...
    invoke-static {p1}, Liag$f;->a(Landroid/content/res/Resources$Theme;)V
...
.method public calculateApplicationLocales(Landroid/content/Context;)Lok9;
    .locals 3
    ...
    invoke-static {v0, p1}, Ltk9;->b(Lok9;Lok9;)Lok9;
...
.method public checkCloseActionMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-interface {v0}, Laz4;->dismissPopups()V
...
.method public closePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    ...
    .line 3
    invoke-interface {v0}, Laz4;->isOverflowMenuShowing()Z
...
.method public createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget v1, Lrof;->AppCompatTheme_viewInflaterClass:I
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mLayoutIncludeDetector:Lv99;
    ...
    iput-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mLayoutIncludeDetector:Lv99;

    :cond_2
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mLayoutIncludeDetector:Lv99;

    invoke-virtual {v1, p4}, Lv99;->a(Landroid/util/AttributeSet;)Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v0, p1}, Lz69;->d(Landroid/view/View;Landroid/view/KeyEvent;)Z
...
.method public getConfigurationLocales(Landroid/content/res/Configuration;)Lok9;
    .locals 0

    invoke-static {p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$k;->b(Landroid/content/res/Configuration;)Lok9;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Lj3c;->c(Landroid/app/Activity;)Ljava/lang/String;
...
.method public onDestroy()V
    ...
    sget-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Lk3i;
    ...
    invoke-virtual {v0, v1}, Lk3i;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public setConfigurationLocales(Landroid/content/res/Configuration;Lok9;)V
    .locals 0

    invoke-static {p1, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl$k;->d(Landroid/content/res/Configuration;Lok9;)V
...
.method public setDefaultLocalesForLocaleList(Lok9;)V
    .locals 0

    invoke-static {p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$k;->c(Lok9;)V
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Laz4;->setWindowTitle(Ljava/lang/CharSequence;)V
...
.method public startSupportActionMode(Landroidx/appcompat/view/a$a;)Landroidx/appcompat/view/a;
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAppCompatCallback:Lis;

    if-eqz v1, :cond_1

    invoke-interface {v1, p1}, Lis;->onSupportActionModeStarted(Landroidx/appcompat/view/a;)V
...
.method public startSupportActionModeFromWindow(Landroidx/appcompat/view/a$a;)Landroidx/appcompat/view/a;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAppCompatCallback:Lis;
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lis;->onWindowStartingSupportActionMode(Landroidx/appcompat/view/a$a;)Landroidx/appcompat/view/a;
    ...
    sget v6, Ljbf;->actionModePopupWindowStyle:I
    ...
    invoke-static {v5, v6}, Lhje;->b(Landroid/widget/PopupWindow;I)V
    ...
    sget v4, Lref;->action_mode_bar_stub:I
    ...
    invoke-interface {p1, v0, v3}, Landroidx/appcompat/view/a$a;->a(Landroidx/appcompat/view/a;Landroid/view/Menu;)Z
    ...
    invoke-interface {v0, p1}, Lis;->onSupportActionModeStarted(Landroidx/appcompat/view/a;)V
...
.method public final updateStatusGuard(Landroidx/core/view/c;Landroid/graphics/Rect;)I
    ...
    invoke-static {p1, v4, v6}, Lxal;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Landroid/content/Context;Ljava/lang/String;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Lq6j$a;Z)V",
        "writable",
        ...
        "Lho7;",
        "getWrappedDb",
        "(Landroid/database/sqlite/SQLiteDatabase;)Lho7;",
        "Lahk;",
        "onCreate",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$c;-><init>(Lv65;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Lq6j$a;Z)V
    .locals 6

    iget v4, p4, Lq6j$a;->a:I

    new-instance v5, Landroidx/sqlite/db/framework/a;

    invoke-direct {v5, p4, p3}, Landroidx/sqlite/db/framework/a;-><init>(Lq6j$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;)V
    ...
    iput-object p4, v0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->callback:Lq6j$a;
    ...
    invoke-direct {p1, p2, p3, p4}, Ldqe;-><init>(Ljava/lang/String;Ljava/io/File;Z)V

    iput-object p1, v0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->lock:Ldqe;

    return-void
.end method

.method private static final _init_$lambda$0(Lq6j$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$c;->a(Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)Lho7;

    move-result-object p1

    invoke-virtual {p0, p1}, Lq6j$a;->c(Lo6j;)V

    return-void
.end method

.method public static synthetic a(Lq6j$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->_init_$lambda$0(Lq6j$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public close()V
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->lock:Ldqe;
    ...
    invoke-static {v0, v3, v1, v2}, Ldqe;->c(Ldqe;ZILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v2}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;->b(Lho7;)V
    ...
    iget-object v1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->lock:Ldqe;

    invoke-virtual {v1}, Ldqe;->d()V
...
.method public final getCallback()Lq6j$a;
    .locals 1

    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->callback:Lq6j$a;
...
.method public final getSupportDatabase(Z)Lo6j;
    .locals 3
    ...
    :goto_0
    invoke-virtual {v0, v1}, Ldqe;->b(Z)V
    ...
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->getSupportDatabase(Z)Lo6j;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, v0}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->getWrappedDb(Landroid/database/sqlite/SQLiteDatabase;)Lho7;
...
.method public final getWrappedDb(Landroid/database/sqlite/SQLiteDatabase;)Lho7;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$c;->a(Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)Lho7;
...
.method public onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->getWrappedDb(Landroid/database/sqlite/SQLiteDatabase;)Lho7;

    move-result-object p1

    invoke-virtual {v0, p1}, Lq6j$a;->b(Lo6j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, p1}, Lq6j$a;->d(Lo6j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lq6j$a;->e(Lo6j;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, p1}, Lq6j$a;->f(Lo6j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lq6j$a;->g(Lo6j;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

...
.field public static volatile c:Ly14;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ly14;->b:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ly14;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static a()Ly14;
    ...
    sget-object v0, Ly14;->b:Ljava/lang/Object;
...
.method public static final g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-static {p0, p1, p3, p4, p2}, Lx14;->a(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Ly14;->f(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Ly14;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Ly14;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Ly14;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    invoke-static {p1, p2}, Ly14;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual/range {v0 .. v7}, Ly14;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    :try_start_0
    invoke-static {p1}, Lvwl;->a(Landroid/content/Context;)Lxld;

    move-result-object v2

    invoke-virtual {v2, p6, v1}, Lxld;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Ly14;->f(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Ly14;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Ly14;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    iget-object p2, p0, Ly14;->a:Ljava/util/concurrent/ConcurrentHashMap;

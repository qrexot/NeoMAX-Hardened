...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLlk3;Landroid/os/Bundle;Lcom/google/android/gms/common/api/c$a;Lcom/google/android/gms/common/api/c$b;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/gms/common/internal/b;-><init>(Landroid/content/Context;Landroid/os/Looper;ILlk3;Lcom/google/android/gms/common/api/c$a;Lcom/google/android/gms/common/api/c$b;)V

    const/4 p1, 0x1

    iput-boolean p1, v0, Le1i;->A0:Z

    iput-object v4, v0, Le1i;->B0:Llk3;

    iput-object p5, v0, Le1i;->C0:Landroid/os/Bundle;

    invoke-virtual {v4}, Llk3;->g()Ljava/lang/Integer;

    move-result-object p1

    iput-object p1, v0, Le1i;->D0:Ljava/lang/Integer;

    return-void
.end method

.method public static U(Llk3;)Landroid/os/Bundle;
    .locals 4

    invoke-virtual {p0}, Llk3;->f()Lf1i;

    invoke-virtual {p0}, Llk3;->g()Ljava/lang/Integer;
    ...
    invoke-virtual {p0}, Llk3;->a()Landroid/accounts/Account;
...
.method public final a(Lcom/google/android/gms/signin/internal/zae;)V
    ...
    :try_start_0
    iget-object v2, p0, Le1i;->B0:Llk3;

    invoke-virtual {v2}, Llk3;->b()Landroid/accounts/Account;
    ...
    invoke-static {v3}, Lcvi;->a(Landroid/content/Context;)Lcvi;

    move-result-object v3

    invoke-virtual {v3}, Lcvi;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    iget-object v5, p0, Le1i;->D0:Ljava/lang/Integer;
...
.method public final k()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Le1i;->B0:Llk3;

    invoke-virtual {v0}, Llk3;->d()Ljava/lang/String;
    ...
    iget-object v0, p0, Le1i;->C0:Landroid/os/Bundle;

    iget-object v1, p0, Le1i;->B0:Llk3;

    const-string v2, "com.google.android.gms.signin.internal.realClientPackageName"

    invoke-virtual {v1}, Llk3;->d()Ljava/lang/String;

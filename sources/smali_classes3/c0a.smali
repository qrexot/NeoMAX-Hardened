...
.method public static a(Landroid/content/Context;II)Landroid/graphics/Rect;
    ...
    sget-object v2, Lbof;->MaterialAlertDialog:[I
    ...
    sget p1, Lbof;->MaterialAlertDialog_backgroundInsetStart:I

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p2

    sget v1, Lacf;->mtrl_alert_dialog_background_inset_start:I
    ...
    sget p2, Lbof;->MaterialAlertDialog_backgroundInsetTop:I

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lacf;->mtrl_alert_dialog_background_inset_top:I
    ...
    sget v1, Lbof;->MaterialAlertDialog_backgroundInsetEnd:I

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    sget v3, Lacf;->mtrl_alert_dialog_background_inset_end:I
    ...
    sget v2, Lbof;->MaterialAlertDialog_backgroundInsetBottom:I

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lacf;->mtrl_alert_dialog_background_inset_bottom:I

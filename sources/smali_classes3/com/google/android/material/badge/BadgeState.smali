...
.method public constructor <init>(Landroid/content/Context;IIILcom/google/android/material/badge/BadgeState$State;)V
    ...
    sget p4, Lbof;->Badge_badgeRadius:I
    ...
    sget v2, Lacf;->mtrl_badge_horizontal_edge_offset:I
    ...
    sget v2, Lacf;->mtrl_badge_text_horizontal_edge_offset:I
    ...
    sget p4, Lbof;->Badge_badgeWithTextRadius:I
    ...
    sget p4, Lbof;->Badge_badgeWidth:I

    sget v2, Lacf;->m3_badge_size:I
    ...
    sget p4, Lbof;->Badge_badgeWithTextWidth:I

    sget v2, Lacf;->m3_badge_with_text_size:I
    ...
    sget p4, Lbof;->Badge_badgeHeight:I
    ...
    sget p4, Lbof;->Badge_badgeWithTextHeight:I
    ...
    sget p4, Lbof;->Badge_offsetAlignmentMode:I
    ...
    :cond_5
    sget p4, Lbof;->Badge_badgeText:I
    ...
    sget p4, Ldkf;->mtrl_badge_numberless_content_description:I
    ...
    sget p4, Ljjf;->mtrl_badge_content_description:I
    ...
    sget p4, Ldkf;->mtrl_exceed_max_badge_number_content_description:I
    ...
    sget p4, Lbof;->Badge_maxCharacterCount:I
    ...
    sget p4, Lbof;->Badge_maxNumber:I
    ...
    sget p4, Lbof;->Badge_badgeShapeAppearance:I

    sget v1, Llnf;->ShapeAppearance_M3_Sys_Shape_Corner_Full:I
    ...
    sget p4, Lbof;->Badge_badgeShapeAppearanceOverlay:I
    ...
    sget p4, Lbof;->Badge_badgeWithTextShapeAppearance:I
    ...
    sget p4, Lbof;->Badge_badgeWithTextShapeAppearanceOverlay:I
    ...
    sget p4, Lbof;->Badge_backgroundColor:I
    ...
    sget p4, Lbof;->Badge_badgeTextAppearance:I

    sget v1, Llnf;->TextAppearance_MaterialComponents_Badge:I
    ...
    :cond_14
    sget p4, Lbof;->Badge_badgeTextColor:I
    ...
    invoke-direct {p4, p1, v1}, Lgnj;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p4}, Lgnj;->i()Landroid/content/res/ColorStateList;
    ...
    sget p1, Lbof;->Badge_badgeGravity:I
    ...
    sget p1, Lbof;->Badge_badgeWidePadding:I

    sget p4, Lacf;->mtrl_badge_long_text_horizontal_padding:I
    ...
    sget p1, Lbof;->Badge_badgeVerticalPadding:I

    sget p4, Lacf;->m3_badge_with_text_vertical_padding:I
    ...
    sget p1, Lbof;->Badge_horizontalOffset:I
    ...
    sget p1, Lbof;->Badge_verticalOffset:I
    ...
    sget p1, Lbof;->Badge_horizontalOffsetWithText:I
    ...
    sget p1, Lbof;->Badge_verticalOffsetWithText:I
    ...
    sget p1, Lbof;->Badge_largeFontVerticalOffsetAdjustment:I
    ...
    sget p1, Lbof;->Badge_autoAdjustToWithinGrandparentBounds:I
...
.method public static J(Landroid/content/Context;Landroid/content/res/TypedArray;I)I
    ...
    invoke-static {p0, p1, p2}, Lf0a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final c(Landroid/content/Context;III)Landroid/content/res/TypedArray;
    ...
    invoke-static {p1, p2, v1}, Lny5;->k(Landroid/content/Context;ILjava/lang/CharSequence;)Landroid/util/AttributeSet;

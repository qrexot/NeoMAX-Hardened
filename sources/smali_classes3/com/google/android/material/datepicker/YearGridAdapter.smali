...
.method public g0(Lcom/google/android/material/datepicker/YearGridAdapter$a;I)V
    ...
    invoke-static {v1, p2}, Lxv4;->k(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/datepicker/MaterialCalendar;->getCalendarStyle()Le61;
    ...
    iget-object v3, v0, Le61;->f:Ld61;

    goto :goto_0

    :cond_0
    iget-object v3, v0, Le61;->d:Ld61;
    ...
    invoke-virtual {v3, v0}, Ld61;->d(Landroid/widget/TextView;)V

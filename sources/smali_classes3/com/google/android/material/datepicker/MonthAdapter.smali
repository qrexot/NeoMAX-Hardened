...
.method private getDayContentDescription(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lxv4;->e(Landroid/content/Context;JZZZ)Ljava/lang/String;
...
.method private initializeStyles(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Le61;

    if-nez v0, :cond_0

    new-instance v0, Le61;

    invoke-direct {v0, p1}, Le61;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Le61;
...
.method private isSelected(J)Z
    ...
    invoke-static {p1, p2}, Lwqk;->a(J)J

    move-result-wide v3

    invoke-static {v1, v2}, Lwqk;->a(J)J
...
.method private updateSelectedState(Landroid/widget/TextView;JI)V
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/MonthAdapter;->calendarStyle:Le61;

    iget-object p2, p2, Le61;->b:Ld61;
    ...
    invoke-virtual {p2, p1, p3, p4}, Ld61;->e(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    :cond_4
    invoke-virtual {p2, p1}, Ld61;->d(Landroid/widget/TextView;)V

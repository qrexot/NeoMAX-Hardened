...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, p3, p4}, Li0a;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    sget-object v2, Lbof;->NavigationBarView:[I

    sget v1, Lbof;->NavigationBarView_itemTextAppearanceInactive:I

    sget v3, Lbof;->NavigationBarView_itemTextAppearanceActive:I
    ...
    sget p1, Lbof;->NavigationBarView_itemIconTint:I
    ...
    invoke-virtual {p2, p1}, Lhwj;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    sget p1, Lbof;->NavigationBarView_itemIconSize:I

    invoke-virtual {p0}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget v6, Lacf;->mtrl_navigation_bar_item_default_icon_size:I

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    invoke-virtual {p2, p1, v5}, Lhwj;->f(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setItemIconSize(I)V

    sget p1, Lbof;->NavigationBarView_itemTextAppearanceInactive:I
    ...
    invoke-virtual {p2, p1, v5}, Lhwj;->n(II)I
    ...
    :cond_1
    sget p1, Lbof;->NavigationBarView_itemTextAppearanceActive:I
    ...
    :cond_2
    sget p1, Lbof;->NavigationBarView_itemTextAppearanceActiveBoldEnabled:I

    invoke-virtual {p2, p1, v2}, Lhwj;->a(IZ)Z
    ...
    sget p1, Lbof;->NavigationBarView_itemTextColor:I
    ...
    invoke-static {p1}, Lny5;->g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    :cond_6
    sget p1, Lbof;->NavigationBarView_itemPaddingTop:I
    ...
    :cond_7
    sget p1, Lbof;->NavigationBarView_itemPaddingBottom:I
    ...
    :cond_8
    sget p1, Lbof;->NavigationBarView_activeIndicatorLabelPadding:I
    ...
    :cond_9
    sget p1, Lbof;->NavigationBarView_elevation:I
    ...
    :cond_a
    sget p1, Lbof;->NavigationBarView_backgroundTint:I
    ...
    invoke-static {v1, p1}, Lxx5;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    sget p1, Lbof;->NavigationBarView_labelVisibilityMode:I

    const/4 v1, -0x1

    invoke-virtual {p2, p1, v1}, Lhwj;->l(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setLabelVisibilityMode(I)V

    sget p1, Lbof;->NavigationBarView_itemBackground:I
    ...
    :cond_b
    sget p1, Lbof;->NavigationBarView_itemRippleColor:I
    ...
    :goto_1
    sget p1, Lbof;->NavigationBarView_itemActiveIndicatorStyle:I
    ...
    sget-object v1, Lbof;->NavigationBarActiveIndicator:[I

    invoke-virtual {v0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, Lbof;->NavigationBarActiveIndicator_android_width:I
    ...
    sget v1, Lbof;->NavigationBarActiveIndicator_android_height:I
    ...
    sget v1, Lbof;->NavigationBarActiveIndicator_marginHorizontal:I
    ...
    sget v1, Lbof;->NavigationBarActiveIndicator_android_color:I
    ...
    sget v1, Lbof;->NavigationBarActiveIndicator_shapeAppearance:I
    ...
    :cond_c
    sget p1, Lbof;->NavigationBarView_menu:I

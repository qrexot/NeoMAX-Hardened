...
# instance fields
.field private activePresenter:Lzuj;
...
.method public static synthetic b(Lcom/google/android/material/timepicker/MaterialTimePicker;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;
...
.method private dataForMode(I)Landroid/util/Pair;
    ...
    sget v1, Ldkf;->material_timepicker_clock_mode_description:I
    ...
    sget v1, Ldkf;->material_timepicker_text_input_mode_description:I
...
.method private getThemeResId()I
    ...
    sget v1, Libf;->materialTimePickerTheme:I

    invoke-static {v0, v1}, Ltz9;->a(Landroid/content/Context;I)Landroid/util/TypedValue;
...
.method private initializeOrRetrieveActivePresenterForMode(ILcom/google/android/material/timepicker/TimePickerView;Landroid/view/ViewStub;)Lzuj;
    .locals 0
...
.method private updateInputMode(Lcom/google/android/material/button/MaterialButton;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Lzuj;->hide()V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/google/android/material/timepicker/MaterialTimePicker;->initializeOrRetrieveActivePresenterForMode(ILcom/google/android/material/timepicker/TimePickerView;Landroid/view/ViewStub;)Lzuj;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;

    invoke-interface {v0}, Lzuj;->show()V

    iget-object v0, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;

    invoke-interface {v0}, Lzuj;->invalidate()V
...
.method public final onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    sget v2, Libf;->materialTimePickerStyle:I

    sget v3, Llnf;->Widget_MaterialComponents_TimePicker:I
    ...
    sget-object v2, Lbof;->MaterialTimePicker:[I

    sget v3, Libf;->materialTimePickerStyle:I

    sget v5, Llnf;->Widget_MaterialComponents_TimePicker:I
    ...
    sget v3, Lbof;->MaterialTimePicker_clockIcon:I
    ...
    sget v3, Lbof;->MaterialTimePicker_keyboardIcon:I
    ...
    sget v3, Lbof;->MaterialTimePicker_backgroundTint:I
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Luif;->material_timepicker_dialog:I
    ...
    sget p2, Lqef;->material_timepicker_view:I
    ...
    sget p2, Lqef;->material_textinput_timepicker:I
    ...
    sget p2, Lqef;->material_timepicker_mode_button:I
    ...
    sget p2, Lqef;->material_timepicker_ok_button:I
    ...
    :cond_3
    :goto_1
    sget p2, Lqef;->material_timepicker_cancel_button:I
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iget-object p2, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;
    ...
    invoke-direct {p2, p0}, Lj0a;-><init>(Lcom/google/android/material/timepicker/MaterialTimePicker;)V
...
.method public setActivePresenter(Lzuj;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;
...
.method public setHour(I)V
    ...
    iget-object p1, p0, Lcom/google/android/material/timepicker/MaterialTimePicker;->activePresenter:Lzuj;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lzuj;->invalidate()V

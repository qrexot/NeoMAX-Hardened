...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lpnj;
...
.method private calculateTextCenterFromBaseline()F
    ...
    iget-object v0, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lpnj;
...
.method private createMarkerEdge()Lr36;
    .locals 7
    ...
    invoke-direct {v2, v3}, Liz9;-><init>(F)V

    invoke-direct {v1, v2, v0}, Lxmc;-><init>(Lr36;F)V
...
.method private drawText(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lpnj;
    ...
    invoke-virtual {v2, v3}, Lpnj;->n(Landroid/content/Context;)V
...
.method private getTextWidth()F
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lpnj;

    invoke-interface {v0}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lpnj;->h(Ljava/lang/String;)F
...
.method private loadFromAttributes(Landroid/util/AttributeSet;II)V
    ...
    sget p3, Lacf;->mtrl_tooltip_arrowSize:I
    ...
    sget p2, Lbof;->Tooltip_showMarker:I
    ...
    invoke-direct {p0}, Lcom/google/android/material/tooltip/TooltipDrawable;->createMarkerEdge()Lr36;

    move-result-object p3

    invoke-virtual {p2, p3}, Lcom/google/android/material/shape/a$b;->s(Lr36;)Lcom/google/android/material/shape/a$b;
    ...
    :goto_0
    sget p2, Lbof;->Tooltip_android_text:I
    ...
    sget p3, Lbof;->Tooltip_android_textAppearance:I

    invoke-static {p2, p1, p3}, Lf0a;->h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lgnj;

    move-result-object p2

    if-eqz p2, :cond_1

    sget p3, Lbof;->Tooltip_android_textColor:I
    ...
    invoke-static {p3, p1, v0}, Lf0a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    invoke-virtual {p2, p3}, Lgnj;->k(Landroid/content/res/ColorStateList;)V

    :cond_1
    invoke-virtual {p0, p2}, Lcom/google/android/material/tooltip/TooltipDrawable;->setTextAppearance(Lgnj;)V

    iget-object p2, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->context:Landroid/content/Context;

    sget p3, Libf;->colorOnBackground:I
    ...
    invoke-static {p2, p3, v1}, La0a;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    invoke-static {p3, v1, v2}, La0a;->c(Landroid/content/Context;ILjava/lang/String;)I

    move-result p3

    const/16 v1, 0xe5

    invoke-static {p3, v1}, Lio3;->p(II)I
    ...
    invoke-static {p3, p2}, La0a;->i(II)I

    move-result p2

    sget p3, Lbof;->Tooltip_backgroundTint:I
    ...
    sget p3, Libf;->colorSurface:I

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v0

    invoke-static {p2, p3, v0}, La0a;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    sget p2, Lbof;->Tooltip_android_padding:I
    ...
    sget p2, Lbof;->Tooltip_android_minWidth:I
    ...
    sget p2, Lbof;->Tooltip_android_minHeight:I
    ...
    sget p2, Lbof;->Tooltip_android_layout_margin:I
...
.method public onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v0}, Lcom/google/android/material/shape/a$b;->s(Lr36;)Lcom/google/android/material/shape/a$b;
...
.method public setText(Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/tooltip/TooltipDrawable;->textDrawableHelper:Lpnj;
...
.method public setTextAppearanceResource(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/tooltip/TooltipDrawable;->setTextAppearance(Lgnj;)V

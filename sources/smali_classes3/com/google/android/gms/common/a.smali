...
.method public final q(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/Dialog;
    ...
    :cond_2
    invoke-static {p1, p2}, Ldhm;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Ldhm;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1, p2}, Ldhm;->f(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Ldhm;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final s(Landroid/content/Context;Lahm;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Lahm;)V

    invoke-static {p1, v1, v0}, Lvim;->r(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public final u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Ldhm;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2}, Ldhm;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    new-instance v3, Loec$d;

    invoke-direct {v3, p1}, Loec$d;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Loec$d;->A(Z)Loec$d;

    move-result-object v3

    invoke-virtual {v3, v4}, Loec$d;->h(Z)Loec$d;

    move-result-object v3

    invoke-virtual {v3, p3}, Loec$d;->o(Ljava/lang/CharSequence;)Loec$d;

    move-result-object p3

    new-instance v3, Loec$b;

    invoke-direct {v3}, Loec$b;-><init>()V

    invoke-virtual {v3, v0}, Loec$b;->h(Ljava/lang/CharSequence;)Loec$b;

    move-result-object v3

    invoke-virtual {p3, v3}, Loec$d;->L(Loec$i;)Loec$d;

    move-result-object p3

    invoke-static {p1}, Lhm5;->b(Landroid/content/Context;)Z
    ...
    invoke-virtual {p3, v0}, Loec$d;->I(I)Loec$d;

    move-result-object v0

    invoke-virtual {v0, v5}, Loec$d;->D(I)Loec$d;

    invoke-static {p1}, Lhm5;->c(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_3

    sget v0, Laef;->common_full_open_on_phone:I

    sget v3, Lbnf;->common_open_on_phone:I

    invoke-virtual {v1, v3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p3, v0, v1, p4}, Loec$d;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Loec$d;

    goto :goto_0

    :cond_3
    invoke-virtual {p3, p4}, Loec$d;->m(Landroid/app/PendingIntent;)Loec$d;
    ...
    invoke-virtual {p3, v3}, Loec$d;->I(I)Loec$d;

    move-result-object v3

    sget v6, Lbnf;->common_google_play_services_notification_ticker:I

    invoke-virtual {v1, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v3, v1}, Loec$d;->M(Ljava/lang/CharSequence;)Loec$d;
    ...
    invoke-virtual {v1, v6, v7}, Loec$d;->Q(J)Loec$d;

    move-result-object v1

    invoke-virtual {v1, p4}, Loec$d;->m(Landroid/app/PendingIntent;)Loec$d;

    move-result-object p4

    invoke-virtual {p4, v0}, Loec$d;->n(Ljava/lang/CharSequence;)Loec$d;

    :goto_0
    invoke-static {}, Lm8e;->f()Z
    ...
    sget v1, Lbnf;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    invoke-virtual {p3, v0}, Loec$d;->k(Ljava/lang/String;)Loec$d;

    :goto_2
    invoke-virtual {p3}, Loec$d;->c()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p2, Lkz7;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final w(Landroid/app/Activity;Lic9;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 7
    ...
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/zag;->zad(Lic9;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/zag;
...
.method public final x(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-static {p1}, Lls8;->a(Landroid/content/Context;)Z

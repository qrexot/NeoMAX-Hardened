...
.field private extractorOutput:Lhp6;

.field private lastChunkIndex:Lih3;
...
.field private final primaryTrackManifestFormat:Lcom/google/android/exoplayer2/s;
...
.field private timestampAdjuster:Lbwj;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lckd;->a()Landroid/media/MediaParser$SeekPoint;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v2, v0, v1}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;-><init>(Lcom/google/android/exoplayer2/s;IZ)V

    return-void
.end method

.method public constructor <init>(Lcom/google/android/exoplayer2/s;IZ)V
    .locals 0
    ...
    .line 4
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->primaryTrackManifestFormat:Lcom/google/android/exoplayer2/s;
    ...
    invoke-direct {p1}, Ld16;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhp6;
...
.method private static getColorInfo(Landroid/media/MediaFormat;)Lyn3;
    .locals 6
    ...
    invoke-static {p0, v2, v3}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v2

    const-string v4, "color-range"

    invoke-static {p0, v4, v3}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v4

    const-string v5, "color-standard"

    invoke-static {p0, v5, v3}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-direct {v1, p0, v4, v2, v0}, Lyn3;-><init>(III[B)V
...
.method private static getFlag(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {p0, p1, v0}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
...
.method private maybeEndTracks()V
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhp6;
...
.method private maybeObtainChunkIndex(Landroid/media/MediaFormat;)Z
    ...
    invoke-direct {p1, v3, v4, v5, v6}, Lih3;-><init>([I[J[J[J)V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lih3;
...
.method private toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Ls3k$a;
    .locals 5
    ...
    invoke-static {v2, v1, v0}, Lyl9;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v2, v3, v4, v1, v0}, Ls3k$a;-><init>(I[BII)V
...
.method private static toExoPlayerDrmInitData(Ljava/lang/String;Landroid/media/DrmInitData;)Lcom/google/android/exoplayer2/drm/DrmInitData;
    ...
    :cond_0
    invoke-static {p1}, Ldkd;->a(Landroid/media/DrmInitData;)I
    ...
    invoke-static {p1, v2}, Lekd;->a(Landroid/media/DrmInitData;I)Landroid/media/DrmInitData$SchemeInitData;

    move-result-object v3

    new-instance v4, Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;

    invoke-static {v3}, Lujd;->a(Landroid/media/DrmInitData$SchemeInitData;)Ljava/util/UUID;
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Lcom/google/android/exoplayer2/s;
    .locals 8

    invoke-static {p1}, Lxjd;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
    ...
    invoke-static {v0, v2, v3}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {p1}, Lakd;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/DrmInitData;
    ...
    invoke-virtual {v4, p1}, Lcom/google/android/exoplayer2/s$b;->M(Lcom/google/android/exoplayer2/drm/DrmInitData;)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->K(Ljava/lang/String;)Lcom/google/android/exoplayer2/s$b;

    move-result-object p1

    const-string v4, "bitrate"

    invoke-static {v0, v4, v3}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v4

    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->Z(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->H(I)Lcom/google/android/exoplayer2/s$b;

    move-result-object p1

    invoke-static {v0}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->getColorInfo(Landroid/media/MediaFormat;)Lyn3;

    move-result-object v4

    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->J(Lyn3;)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->I(Ljava/lang/String;)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-static {v0, v4, v5}, Lyjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;F)F

    move-result v4

    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->P(F)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->j0(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->T(Ljava/util/List;)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->V(Ljava/lang/String;)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->W(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->Y(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-static {v0, v4, v5}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v4

    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/s$b;->d0(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-static {v0, v3, v5}, Ltjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v3

    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/s$b;->N(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/s$b;->O(I)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-static {v0, v3, v4}, Lyjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;F)F

    move-result v3

    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/s$b;->a0(F)Lcom/google/android/exoplayer2/s$b;
    ...
    invoke-static {v0, v3, v6, v7}, Lzjd;->a(Landroid/media/MediaFormat;Ljava/lang/String;J)J

    move-result-wide v3

    invoke-virtual {p1, v3, v4}, Lcom/google/android/exoplayer2/s$b;->i0(J)Lcom/google/android/exoplayer2/s$b;

    move-result-object p1

    invoke-virtual {p1, v2}, Lcom/google/android/exoplayer2/s$b;->F(I)Lcom/google/android/exoplayer2/s$b;
    ...
    iget-object v3, v0, Lcom/google/android/exoplayer2/s;->H:Ljava/lang/String;

    invoke-static {v3, v1}, Lprk;->c(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_0

    iget v3, v0, Lcom/google/android/exoplayer2/s;->v0:I

    if-ne v3, v2, :cond_0

    iget-object v1, v0, Lcom/google/android/exoplayer2/s;->y:Ljava/lang/String;

    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/s$b;->V(Ljava/lang/String;)Lcom/google/android/exoplayer2/s$b;

    move-result-object v1

    iget v2, v0, Lcom/google/android/exoplayer2/s;->A:I

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/s$b;->c0(I)Lcom/google/android/exoplayer2/s$b;

    move-result-object v1

    iget v2, v0, Lcom/google/android/exoplayer2/s;->z:I

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/s$b;->g0(I)Lcom/google/android/exoplayer2/s$b;

    move-result-object v1

    iget-object v2, v0, Lcom/google/android/exoplayer2/s;->x:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/s$b;->U(Ljava/lang/String;)Lcom/google/android/exoplayer2/s$b;

    move-result-object v1

    iget-object v0, v0, Lcom/google/android/exoplayer2/s;->F:Lcom/google/android/exoplayer2/metadata/Metadata;

    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/s$b;->X(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/s$b;
...
.method public getChunkIndex()Lih3;
    .locals 1

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lih3;
...
.method public getSampleFormats()[Lcom/google/android/exoplayer2/s;
    .locals 3
...
.method public onSampleCompleted(IJIIILandroid/media/MediaCodec$CryptoInfo;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lbwj;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, p3}, Lbwj;->a(J)J
    ...
    invoke-direct {p0, p1, p7}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Ls3k$a;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-interface {v0, p1, v1}, Lhp6;->b(II)Ls3k;
    ...
    invoke-static {p2}, Lwjd;->a(Landroid/media/MediaParser$InputReader;)J
    ...
    invoke-interface {v0, p1, p2, v1}, Ls3k;->f(Lgu4;IZ)I
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    invoke-static {p1}, Lvjd;->a(Landroid/media/MediaParser$SeekMap;)J

    move-result-wide v0

    iget-object v2, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lhp6;
    ...
    :goto_1
    invoke-interface {v2, p1}, Lhp6;->m(Ls2h;)V
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-static {p2}, Lxjd;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
    ...
    invoke-interface {v2, p1, v1}, Lhp6;->b(II)Ls3k;
    ...
    :cond_4
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Lcom/google/android/exoplayer2/s;

    move-result-object p2

    iget-object v1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->primaryTrackManifestFormat:Lcom/google/android/exoplayer2/s;
    ...
    invoke-virtual {p2, v1}, Lcom/google/android/exoplayer2/s;->k(Lcom/google/android/exoplayer2/s;)Lcom/google/android/exoplayer2/s;
...
.method public setExtractorOutput(Lhp6;)V
    .locals 0
...
.method public setTimestampAdjuster(Lbwj;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lbwj;

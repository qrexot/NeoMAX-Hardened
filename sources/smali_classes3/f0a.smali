...
# direct methods
.method public static a(Landroid/content/Context;Lhwj;I)Landroid/content/res/ColorStateList;
    .locals 1

    invoke-virtual {p1, p2}, Lhwj;->s(I)Z
    ...
    invoke-virtual {p1, p2, v0}, Lhwj;->n(II)I

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, v0}, Lat;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public static h(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lgnj;
    .locals 1
    ...
    invoke-direct {p2, p0, p1}, Lgnj;-><init>(Landroid/content/Context;I)V
...
.method public static i(Landroid/content/Context;II)I
    ...
    sget v1, Lbof;->TextAppearance_android_textSize:I
    ...
    :cond_1
    invoke-static {v0}, Lf0a;->c(Landroid/util/TypedValue;)I

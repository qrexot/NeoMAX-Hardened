...
.method public static b(Ljava/util/Iterator;Lmle;)Z
    .locals 0

    invoke-static {p0, p1}, Lny8;->p(Ljava/util/Iterator;Lmle;)I
...
.method public static d(Ljava/util/Iterator;)Ljava/util/Iterator;
    ...
    new-instance v0, Lny8$c;

    invoke-direct {v0, p0}, Lny8$c;-><init>(Ljava/util/Iterator;)V
...
.method public static g()Lthk;
    .locals 1

    invoke-static {}, Lny8;->h()Luhk;
...
.method public static h()Luhk;
    .locals 1

    sget-object v0, Lny8$b;->z:Luhk;
...
.method public static j(Ljava/util/Iterator;Lmle;)Lthk;
    .locals 1
    ...
    new-instance v0, Lny8$a;

    invoke-direct {v0, p0, p1}, Lny8$a;-><init>(Ljava/util/Iterator;Lmle;)V

    return-object v0
.end method

.method public static k(Ljava/util/Iterator;Lmle;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-interface {p1, v0}, Lmle;->apply(Ljava/lang/Object;)Z
...
.method public static p(Ljava/util/Iterator;Lmle;)I
    .locals 2
...
.method public static s(Ljava/util/Iterator;Lmle;)Z
    .locals 2
...
.method public static t(Ljava/lang/Object;)Lthk;
    .locals 1

    new-instance v0, Lny8$e;

    invoke-direct {v0, p0}, Lny8$e;-><init>(Ljava/lang/Object;)V

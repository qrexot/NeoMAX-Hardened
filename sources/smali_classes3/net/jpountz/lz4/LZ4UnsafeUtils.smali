...
.method public static commonBytes([BIII)I
    ...
    invoke-static {p0, p2}, Ldik;->h([BI)J

    move-result-wide v1

    invoke-static {p0, p1}, Ldik;->h([BI)J
    ...
    :cond_0
    sget-object p3, Lyrk;->NATIVE_BYTE_ORDER:Ljava/nio/ByteOrder;
    ...
    invoke-static {p0, p1}, Ldik;->c([BI)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p0, p2}, Ldik;->c([BI)B
...
.method public static readIntEquals([BII)Z
    ...
    invoke-static {p0, p1}, Ldik;->d([BI)I

    move-result p1

    invoke-static {p0, p2}, Ldik;->d([BI)I
...
.method public static safeArraycopy([BI[BII)V
    ...
    invoke-static {p0, v3}, Ldik;->c([BI)B

    move-result v3

    invoke-static {p2, v2, v3}, Ldik;->m([BIB)V
...
.method public static safeIncrementalCopy([BIII)V
    ...
    invoke-static {p0, v2}, Ldik;->c([BI)B

    move-result v2

    invoke-static {p0, v1, v2}, Ldik;->m([BIB)V
...
.method public static wildArraycopy([BI[BII)V
    ...
    invoke-static {p0, v2}, Ldik;->h([BI)J

    move-result-wide v2

    invoke-static {p2, v1, v2, v3}, Ldik;->q([BIJ)V
...
.method public static wildIncrementalCopy([BIII)V
    ...
    invoke-static {p0, v5}, Ldik;->c([BI)B

    move-result v5

    invoke-static {p0, v4, v5}, Ldik;->m([BIB)V
    ...
    :goto_1
    invoke-static {p0, v3}, Ldik;->d([BI)I

    move-result p1

    invoke-static {p0, v2, p1}, Ldik;->o([BII)V
    ...
    invoke-static {p0, p2, v2, v3}, Ldik;->q([BIJ)V
...
.method public static writeLen(I[BI)I
    ...
    invoke-static {p1, p2, v0}, Ldik;->n([BII)V
    ...
    invoke-static {p1, p2, p0}, Ldik;->n([BII)V
...
.method public static writeShortLittleEndian([BII)V
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Ldik;->r([BIS)V

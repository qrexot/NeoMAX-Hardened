...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lwt8;->b:Ljava/lang/String;
...
.method public static final n()Landroid/content/Intent;
    .locals 2
...
.method public static final p(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    .locals 5
    ...
    invoke-static {v2, p1, v1}, Lzl9;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static synthetic t(Lwt8;Landroid/content/Context;Ljava/lang/CharSequence;Landroid/net/Uri;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lwt8;->s(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/net/Uri;)V
...
.method public final a(Ljava/lang/String;Landroid/content/Context;)V
    ...
    sget-object p2, Lwt8;->b:Ljava/lang/String;
...
.method public final d(Landroid/content/Context;Z)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1}, Lwt8;->f(Landroid/content/Context;)Landroid/content/Intent;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lwt8;->c(Landroid/content/Context;)Landroid/content/Intent;
...
.method public final i(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lwt8;->e(Landroid/content/Context;)Landroid/content/Intent;
    ...
    sget-object v0, Lwt8;->b:Ljava/lang/String;
...
.method public final k(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lwt8;->l(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final m(Landroid/content/Context;DDI)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1, p2}, Lwt8;->v(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public final o(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lwt8;->g(Landroid/content/Context;)Landroid/content/Intent;
...
.method public final q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2}, Lj3g;-><init>(Ljava/lang/String;)V
...
.method public final r(Landroid/net/Uri;Ljava/lang/String;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-direct {v0, p3}, Lfth$a;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, p2}, Lfth$a;->h(Ljava/lang/String;)Lfth$a;

    move-result-object p2

    invoke-virtual {p2, p1}, Lfth$a;->f(Landroid/net/Uri;)Lfth$a;
...
.method public final s(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/net/Uri;)V
    .locals 2
    ...
    invoke-static {p3, v1}, Lkv8;->e(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p2, p3}, Lfth$a;->f(Landroid/net/Uri;)Lfth$a;

    move-result-object p2

    invoke-virtual {p2}, Lfth$a;->d()Landroid/content/Intent;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lwt8;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public final u(Landroid/content/Context;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lwt8;->d(Landroid/content/Context;Z)Landroid/content/Intent;
    ...
    sget-object v2, Lwt8;->b:Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lwt8;->c(Landroid/content/Context;)Landroid/content/Intent;
...
.method public final v(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    .locals 3
    ...
    invoke-virtual {p0, p1, v1}, Lwt8;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

...
.method public A()V
    ...
    invoke-static {v1}, Lyhe;->a(Landroid/view/View;)V
...
.method public D(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$t;->H(Landroidx/recyclerview/widget/RecyclerView$b0;)V
...
.method public H(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$g;->U(Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    ...
    invoke-static {v0}, Lyhe;->a(Landroid/view/View;)V

    const/4 v0, 0x0

    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$b0;->mBindingAdapter:Landroidx/recyclerview/widget/RecyclerView$g;
...
.method public I(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p0, v0}, Landroidx/recyclerview/widget/RecyclerView$b0;->setScrapContainer(Landroidx/recyclerview/widget/RecyclerView$t;Z)V
...
.method public final M(Landroidx/recyclerview/widget/RecyclerView$b0;IIJ)Z
    .locals 8
    ...
    invoke-virtual {p4, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$g;->x(Landroidx/recyclerview/widget/RecyclerView$b0;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$t;->b(Landroidx/recyclerview/widget/RecyclerView$b0;)V
...
.method public N(IZJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    .locals 16
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$x;->f()Z
    ...
    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView$t;->Q(Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    ...
    invoke-virtual {v2, v8}, Landroidx/recyclerview/widget/RecyclerView$b0;->addFlags(I)V

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->isScrap()Z
    ...
    iget-object v9, v2, Landroidx/recyclerview/widget/RecyclerView$b0;->itemView:Landroid/view/View;

    invoke-virtual {v8, v9, v7}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->unScrap()V

    goto :goto_1

    :cond_2
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->wasReturnedFromScrap()Z
    ...
    :cond_3
    :goto_1
    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView$t;->H(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {v0, v9, v10, v11, v1}, Landroidx/recyclerview/widget/RecyclerView$t;->l(JIZ)Landroidx/recyclerview/widget/RecyclerView$b0;

    move-result-object v2

    if-eqz v2, :cond_7

    iput v8, v2, Landroidx/recyclerview/widget/RecyclerView$b0;->mPosition:I
    ...
    invoke-virtual {v2, v11}, Landroidx/recyclerview/widget/RecyclerView$s;->getRecycledView(I)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView$t;->r(Landroidx/recyclerview/widget/RecyclerView$b0;)V
    ...
    invoke-virtual {v4, v2, v11}, Landroidx/recyclerview/widget/RecyclerView$g;->z(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iput-object v8, v2, Landroidx/recyclerview/widget/RecyclerView$b0;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    invoke-virtual {v1, v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->hasAnyOfTheFlags(I)Z

    move-result v4

    if-eqz v4, :cond_e

    invoke-virtual {v1, v7, v2}, Landroidx/recyclerview/widget/RecyclerView$b0;->setFlags(II)V

    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView$t;->h:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$x;

    iget-boolean v2, v2, Landroidx/recyclerview/widget/RecyclerView$x;->k:Z
    ...
    invoke-virtual {v5, v4, v1, v2, v9}, Landroidx/recyclerview/widget/RecyclerView$k;->u(Landroidx/recyclerview/widget/RecyclerView$x;Landroidx/recyclerview/widget/RecyclerView$b0;ILjava/util/List;)Landroidx/recyclerview/widget/RecyclerView$k$c;

    move-result-object v2

    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView$t;->h:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v4, v1, v2}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$b0;Landroidx/recyclerview/widget/RecyclerView$k$c;)V
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$b0;->isBound()Z

    move-result v2

    if-eqz v2, :cond_f

    iput v3, v1, Landroidx/recyclerview/widget/RecyclerView$b0;->mPreLayoutPosition:I
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$b0;->needsUpdate()Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/recyclerview/widget/RecyclerView$t;->M(Landroidx/recyclerview/widget/RecyclerView$b0;IIJ)Z
    ...
    :goto_8
    iput-object v1, v3, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mViewHolder:Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public Q(Landroidx/recyclerview/widget/RecyclerView$b0;)Z
    .locals 7
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$b0;Z)V
    ...
    :cond_2
    iput-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$b0;->mBindingAdapter:Landroidx/recyclerview/widget/RecyclerView$g;
    ...
    invoke-virtual {p2, p1}, Landroidx/recyclerview/widget/RecyclerView$s;->putRecycledView(Landroidx/recyclerview/widget/RecyclerView$b0;)V
...
.method public p(IZ)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Landroidx/recyclerview/widget/RecyclerView$t;->N(IZJ)Landroidx/recyclerview/widget/RecyclerView$b0;
...
.method public x(IIZ)V
    ...
    iget v4, v2, Landroidx/recyclerview/widget/RecyclerView$b0;->mPosition:I

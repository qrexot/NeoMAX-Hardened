...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 17
    invoke-static {p1}, Lmrl;->a(Landroid/content/Context;)Lmrl;
    ...
    invoke-direct {p3, p2, p1}, Landroidx/slidingpanelayout/widget/a;-><init>(Lmrl;Ljava/util/concurrent/Executor;)V
...
.method private static getFoldBoundsInView(Lyf7;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 8
    ...
    invoke-interface {p0}, Llr5;->getBounds()Landroid/graphics/Rect;
...
.method private getSystemGestureInsets()Lbs8;
    .locals 1
    ...
    invoke-virtual {v0}, Landroidx/core/view/c;->i()Lbs8;
...
.method private splitViewPositions()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lyf7;

    const/4 v1, 0x0

    if-eqz v0, :cond_3

    invoke-interface {v0}, Lyf7;->a()Z
    ...
    invoke-interface {v0}, Llr5;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-static {v0, p0}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->getFoldBoundsInView(Lyf7;Landroid/view/View;)Landroid/graphics/Rect;
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-direct {p0}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->getSystemGestureInsets()Lbs8;
...
.method public onLayout(ZIIII)V
    ...
    iget-object v7, v0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lyf7;

    if-eqz v7, :cond_a

    invoke-interface {v7}, Lyf7;->b()Lyf7$a;

    move-result-object v7

    sget-object v8, Lyf7$a;->c:Lyf7$a;

    if-ne v7, v8, :cond_a

    iget-object v7, v0, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->mFoldingFeature:Lyf7;

    invoke-interface {v7}, Lyf7;->a()Z
    ...
    invoke-interface {v7}, Llr5;->getBounds()Landroid/graphics/Rect;

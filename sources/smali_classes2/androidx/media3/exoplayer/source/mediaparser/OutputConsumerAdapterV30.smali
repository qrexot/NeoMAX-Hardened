...
.field private extractorOutput:Lgp6;

.field private lastChunkIndex:Ljh3;
...
.field private timestampAdjuster:Lcwj;
...
.method public constructor <init>(Landroidx/media3/common/a;IZ)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lgp6;
...
.method private static getInitializationData(Landroid/media/MediaFormat;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v1}, Lkda;->c(Ljava/nio/ByteBuffer;)[B
...
.method private maybeEndTracks()V
    ...
    :cond_2
    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lgp6;
...
.method private maybeObtainChunkIndex(Landroid/media/MediaFormat;)Z
    ...
    invoke-direct {p1, v3, v4, v5, v6}, Ljh3;-><init>([I[J[J[J)V

    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Ljh3;
...
.method private toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Lr3k$a;
    .locals 5
    ...
    invoke-direct {v2, v3, v4, v1, v0}, Lr3k$a;-><init>(I[BII)V
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Landroidx/media3/common/a;
    ...
    invoke-static {v0}, Lkda;->e(Landroid/media/MediaFormat;)Lxn3;

    move-result-object v4

    invoke-virtual {p1, v4}, Landroidx/media3/common/a$b;->V(Lxn3;)Landroidx/media3/common/a$b;
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/common/a$b;->r0(Llhb;)Landroidx/media3/common/a$b;
...
.method public getChunkIndex()Ljh3;
    .locals 1

    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Ljh3;
...
.method public onSampleCompleted(IJIIILandroid/media/MediaCodec$CryptoInfo;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lcwj;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, p3}, Lcwj;->a(J)J
    ...
    invoke-direct {p0, p1, p7}, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Lr3k$a;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-interface {v0, p1, v1}, Lgp6;->b(II)Lr3k;
    ...
    invoke-interface {v0, p1, p2, v1}, Lr3k;->b(Lhu4;IZ)I
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lgp6;
    ...
    :goto_1
    invoke-interface {v2, p1}, Lgp6;->p(Lr2h;)V
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-interface {v2, p1, v1}, Lgp6;->b(II)Lr3k;
...
.method public setExtractorOutput(Lgp6;)V
    .locals 0
...
.method public setTimestampAdjuster(Lcwj;)V
    .locals 0

    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lcwj;

...
# instance fields
.field public final w:Landroid/media/MediaParser$SeekMap;
...
.method public constructor <init>(Landroid/media/MediaParser$SeekMap;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30$c;->w:Landroid/media/MediaParser$SeekMap;

    return-void
.end method

.method public static a(Landroid/media/MediaParser$SeekPoint;)Lw2h;
    .locals 5
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lw2h;-><init>(JJ)V
...
.method public c(J)Lr2h$a;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30$c;->w:Landroid/media/MediaParser$SeekMap;
    ...
    invoke-static {p2}, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30$c;->a(Landroid/media/MediaParser$SeekPoint;)Lw2h;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30$c;->a(Landroid/media/MediaParser$SeekPoint;)Lw2h;

    move-result-object p1

    invoke-direct {v0, p2, p1}, Lr2h$a;-><init>(Lw2h;Lw2h;)V

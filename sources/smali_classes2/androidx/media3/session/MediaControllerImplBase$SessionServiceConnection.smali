...
.method public onBindingDied(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p1}, Landroidx/media3/session/MediaControllerImplBase;->L1()Landroidx/media3/session/g;
    ...
    invoke-virtual {v0}, Landroidx/media3/session/MediaControllerImplBase;->L1()Landroidx/media3/session/g;
    ...
    invoke-direct {v1, v0}, Lt9a;-><init>(Landroidx/media3/session/g;)V

    invoke-virtual {p1, v1}, Landroidx/media3/session/g;->z(Ljava/lang/Runnable;)V
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-static {v1}, Landroidx/media3/session/MediaControllerImplBase;->o1(Landroidx/media3/session/MediaControllerImplBase;)Lrjh;

    move-result-object v1

    invoke-virtual {v1}, Lrjh;->g()Ljava/lang/String;
    ...
    invoke-static {v0, p2}, Lxl9;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {p2}, Landroidx/media3/session/MediaControllerImplBase;->L1()Landroidx/media3/session/g;
    ...
    invoke-direct {v0, p2}, Lt9a;-><init>(Landroidx/media3/session/g;)V

    :goto_0
    invoke-virtual {p1, v0}, Landroidx/media3/session/g;->z(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v2}, Landroidx/media3/session/MediaControllerImplBase;->J1()Landroid/content/Context;
    ...
    invoke-static {v5}, Landroidx/media3/session/MediaControllerImplBase;->p1(Landroidx/media3/session/MediaControllerImplBase;)Landroidx/media3/session/g;
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Ll14;-><init>(Ljava/lang/String;ILandroid/os/Bundle;I)V

    iget-object v2, p0, Landroidx/media3/session/MediaControllerImplBase$SessionServiceConnection;->this$0:Landroidx/media3/session/MediaControllerImplBase;

    iget-object v2, v2, Landroidx/media3/session/MediaControllerImplBase;->c:Landroidx/media3/session/MediaControllerStub;

    invoke-virtual {v1}, Ll14;->b()Landroid/os/Bundle;
    ...
    invoke-virtual {p2, v1}, Landroidx/media3/session/g;->z(Ljava/lang/Runnable;)V

...
.method public run()V
    ...
    invoke-static {v0}, Landroidx/work/impl/foreground/a;->b(Landroidx/work/impl/foreground/a;)Lvul;
    ...
    invoke-virtual {v0, v1}, Lyqe;->g(Ljava/lang/String;)Lpvl;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lpvl;->h()Z
    ...
    iget-object v2, v0, Landroidx/work/impl/foreground/a;->E:Lytl;

    iget-object v0, v0, Landroidx/work/impl/foreground/a;->D:Ljava/util/Set;

    invoke-interface {v2, v0}, Lytl;->a(Ljava/lang/Iterable;)V

...
.method public constructor <init>(Landroid/content/Context;Lgji;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lgji;
...
.method public static b(Landroid/content/Context;Lmul;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/background/systemalarm/a;->p(Landroid/content/Intent;Lmul;)Landroid/content/Intent;
...
.method public static c(Landroid/content/Context;Lmul;Z)Landroid/content/Intent;
    .locals 2
...
.method public static d(Landroid/content/Context;Lmul;)Landroid/content/Intent;
    .locals 2
...
.method public static e(Landroid/content/Context;Lmul;)Landroid/content/Intent;
    .locals 2
...
.method public static o(Landroid/content/Intent;)Lmul;
    .locals 4
...
.method public static p(Landroid/content/Intent;Lmul;)Landroid/content/Intent;
    .locals 2
...
.method public final g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/work/impl/background/systemalarm/a;->o(Landroid/content/Intent;)Lmul;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lgji;

    invoke-virtual {v3, p1}, Lgji;->d(Lmul;)Lfji;

    move-result-object v3

    invoke-direct {v1, v2, p2, p3, v3}, Landroidx/work/impl/background/systemalarm/c;-><init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;Lfji;)V
    ...
    invoke-virtual {p2, v2, p1}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final h(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v3, p1}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/a;->onExecuted(Lmul;Z)V
...
.method public final j(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-interface {v2, v3}, Lqvl;->n(Ljava/lang/String;)Lpvl;
    ...
    invoke-virtual {p2, v1, p1}, Lgn9;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, Lpvl;->b:Lnul$a;

    invoke-virtual {v4}, Lnul$a;->d()Z
    ...
    invoke-virtual {p2, v1, p3}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    invoke-static {p2, v0, p1, v3, v4}, Lyf;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lmul;J)V
    ...
    invoke-virtual {v2, v1, v5}, Lgn9;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->w:Landroid/content/Context;

    invoke-static {v1, v0, p1, v3, v4}, Lyf;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lmul;J)V
...
.method public final k(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/d;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lgji;

    new-instance v3, Lmul;

    invoke-direct {v3, v0, p1}, Lmul;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v2, v3}, Lgji;->b(Lmul;)Lfji;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->z:Lgji;

    invoke-virtual {p1, v0}, Lgji;->c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/d;->f()Lvul;

    move-result-object v2

    invoke-virtual {v2, v1}, Lvul;->F(Lfji;)V
    ...
    invoke-virtual {v3}, Lvul;->v()Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {v2, v3, v4}, Lyf;->a(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lmul;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/d;->onExecuted(Lmul;Z)V
...
.method public n(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p1, p2, p3}, Lgn9;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p3, p1}, Lgn9;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onExecuted(Lmul;Z)V
    ...
    invoke-virtual {v2, p1}, Lgji;->b(Lmul;)Lfji;

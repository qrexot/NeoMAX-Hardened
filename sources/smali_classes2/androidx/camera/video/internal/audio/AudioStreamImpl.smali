...
.method public constructor <init>(Lja0;Landroid/content/Context;)V
    .locals 4
    ...
    iput-object p1, p0, Landroidx/camera/video/internal/audio/AudioStreamImpl;->b:Lja0;

    invoke-virtual {p1}, Lja0;->d()I
    ...
    invoke-static {v0, p1, p2}, Landroidx/camera/video/internal/audio/AudioStreamImpl;->i(ILja0;Landroid/content/Context;)Landroid/media/AudioRecord;
...
.method public static h(Lja0;)Landroid/media/AudioFormat;
    .locals 2

    invoke-virtual {p0}, Lja0;->e()I
...
.method public static i(ILja0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    invoke-static {p1}, Landroidx/camera/video/internal/audio/AudioStreamImpl;->h(Lja0;)Landroid/media/AudioFormat;

    move-result-object v1

    invoke-static {}, Lrp;->b()Landroid/media/AudioRecord$Builder;
    ...
    invoke-static {v2, p2}, Lvp;->a(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
    ...
    invoke-static {v2, p1}, Lrp;->d(Landroid/media/AudioRecord$Builder;I)V

    invoke-static {v2, v1}, Lrp;->c(Landroid/media/AudioRecord$Builder;Landroid/media/AudioFormat;)V

    invoke-static {v2, p0}, Lrp;->e(Landroid/media/AudioRecord$Builder;I)V

    :try_start_0
    invoke-static {v2}, Lrp;->a(Landroid/media/AudioRecord$Builder;)Landroid/media/AudioRecord;
...
.method public a(Landroidx/camera/video/internal/audio/AudioStream$a;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v1, v0}, Lup;->d(Landroid/media/AudioRecord;Landroid/media/AudioManager$AudioRecordingCallback;)V
    ...
    invoke-static {p1, p2, v0}, Lup;->c(Landroid/media/AudioRecord;Ljava/util/concurrent/Executor;Landroid/media/AudioManager$AudioRecordingCallback;)V
...
.method public final j()J
    ...
    invoke-static {v3, v0, v4}, Lsp;->b(Landroid/media/AudioRecord;Landroid/media/AudioTimestamp;I)I

    move-result v3

    if-nez v3, :cond_0

    iget-object v3, p0, Landroidx/camera/video/internal/audio/AudioStreamImpl;->b:Lja0;

    invoke-virtual {v3}, Lja0;->e()I

    move-result v3

    iget-wide v4, p0, Landroidx/camera/video/internal/audio/AudioStreamImpl;->j:J

    invoke-static {v3, v4, v5, v0}, Lhb0;->c(IJLandroid/media/AudioTimestamp;)J
    ...
    invoke-static {v0, v3}, Lon9;->l(Ljava/lang/String;Ljava/lang/String;)V
...
.method public n(Z)V
    ...
    invoke-direct {v2, v1, p1}, Lab0;-><init>(Landroidx/camera/video/internal/audio/AudioStream$a;Z)V
...
.method public read(Ljava/nio/ByteBuffer;)Landroidx/camera/video/internal/audio/AudioStream$b;
    ...
    invoke-static {v5, v6, p1}, Lhb0;->g(JI)J
...
.method public start()V
    ...
    invoke-static {v0}, Lup;->a(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-static {v0}, Lup;->b(Landroid/media/AudioRecordingConfiguration;)Z
...
.method public stop()V
    ...
    iget-object v1, p0, Landroidx/camera/video/internal/audio/AudioStreamImpl;->b:Lja0;

    const/4 v2, 0x0

    invoke-static {v0, v1, v2}, Landroidx/camera/video/internal/audio/AudioStreamImpl;->i(ILja0;Landroid/content/Context;)Landroid/media/AudioRecord;

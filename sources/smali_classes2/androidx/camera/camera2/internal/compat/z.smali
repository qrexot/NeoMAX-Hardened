.class public Landroidx/camera/camera2/internal/compat/z;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Landroidx/camera/camera2/internal/compat/CameraManagerCompat$a;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Landroidx/camera/camera2/internal/compat/z;->a:Landroid/hardware/camera2/CameraManager;
...
.method public static h(Landroid/content/Context;Landroid/os/Handler;)Landroidx/camera/camera2/internal/compat/z;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroidx/camera/camera2/internal/compat/z;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public a(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/compat/z;->b:Ljava/lang/Object;

    check-cast v0, Landroidx/camera/camera2/internal/compat/z$a;

    if-eqz p2, :cond_1

    iget-object v1, v0, Landroidx/camera/camera2/internal/compat/z$a;->a:Ljava/util/Map;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, Landroidx/camera/camera2/internal/compat/z$a;->a:Ljava/util/Map;
    ...
    iget-object p1, v0, Landroidx/camera/camera2/internal/compat/z$a;->a:Ljava/util/Map;
    ...
    :goto_2
    iget-object p1, p0, Landroidx/camera/camera2/internal/compat/z;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, v0, Landroidx/camera/camera2/internal/compat/z$a;->b:Landroid/os/Handler;
...
.method public b(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V
    ...
    :try_start_0
    iget-object p3, p0, Landroidx/camera/camera2/internal/compat/z;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, p2, Landroidx/camera/camera2/internal/compat/z$a;->b:Landroid/os/Handler;
...
.method public g(Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    :try_start_0
    iget-object v0, v0, Landroidx/camera/camera2/internal/compat/z$a;->a:Ljava/util/Map;

...
.field private mScreenFlash:Lkg8$i;
...
.method private animateToFullOpacity(Ljava/lang/Runnable;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Lsug;-><init>(Landroidx/camera/view/ScreenFlashView;)V
...
.method private setScreenFlashUiInfo(Lkg8$i;)V
    ...
    sget-object v2, Lrug$a;->SCREEN_FLASH_VIEW:Lrug$a;
...
.method private updateScreenFlash(Landroid/view/Window;)V
    ...
    :goto_1
    iput-object p1, p0, Landroidx/camera/view/ScreenFlashView;->mScreenFlash:Lkg8$i;
...
.method public getScreenFlash()Lkg8$i;
    ...
    iget-object v0, p0, Landroidx/camera/view/ScreenFlashView;->mScreenFlash:Lkg8$i;
...
.method public setController(Landroidx/camera/view/a;)V
    ...
    invoke-direct {p0, v0}, Landroidx/camera/view/ScreenFlashView;->setScreenFlashUiInfo(Lkg8$i;)V
    ...
    :cond_1
    invoke-virtual {p1}, Landroidx/camera/view/a;->t()I
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0}, Landroidx/camera/view/ScreenFlashView;->getScreenFlash()Lkg8$i;

    move-result-object p1

    invoke-direct {p0, p1}, Landroidx/camera/view/ScreenFlashView;->setScreenFlashUiInfo(Lkg8$i;)V

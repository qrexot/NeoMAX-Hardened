...
.method private connectViewModel()V
    ...
    invoke-direct {v0, v1}, Landroidx/lifecycle/z;-><init>(Lo9l;)V

    const-class v1, Landroidx/biometric/BiometricViewModel;

    invoke-virtual {v0, v1}, Landroidx/lifecycle/z;->b(Ljava/lang/Class;)Lg9l;
    ...
    invoke-virtual {v0}, Landroidx/biometric/BiometricViewModel;->g()Lcub;
...
.method private dismissFingerprintDialog()V
    ...
    invoke-virtual {v0, v1}, Landroidx/fragment/app/e;->q(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/e;
...
.method private getDismissDialogDelay()I
    ...
    invoke-static {v0, v1}, Lvm5;->f(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private handleConfirmCredentialResult(I)V
    ...
    :cond_0
    sget p1, Lmkf;->generic_error_user_canceled:I
...
.method private isFingerprintDialogNeededForCrypto()Z
    ...
    invoke-static {v0, v1, v2}, Lvm5;->g(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
...
.method private launchConfirmCredentialActivity()V
    ...
    sget v0, Lmkf;->generic_error_no_keyguard:I
    ...
    sget v0, Lmkf;->generic_error_no_device_credential:I
...
.method private showFingerprintDialogForAuthentication()V
    ...
    invoke-static {v0, v2}, Lbf6;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lvm5;->f(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public authenticate(Landroidx/biometric/c$d;Landroidx/biometric/c$c;)V
    ...
    sget p2, Lmkf;->confirm_device_credential_password:I
...
.method public authenticateWithBiometricPrompt(Landroid/hardware/biometrics/BiometricPrompt;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, Landroidx/biometric/BiometricViewModel;->k()Lwg2;

    move-result-object v1

    invoke-virtual {v1}, Lwg2;->b()Landroid/os/CancellationSignal;
...
.method public authenticateWithFingerprint(Landroidx/core/hardware/fingerprint/FingerprintManagerCompat;Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Landroidx/biometric/BiometricViewModel;->k()Lwg2;

    move-result-object v0

    invoke-virtual {v0}, Lwg2;->c()Lvg2;
    ...
    :try_start_0
    invoke-virtual/range {v1 .. v6}, Landroidx/core/hardware/fingerprint/FingerprintManagerCompat;->a(Landroidx/core/hardware/fingerprint/FingerprintManagerCompat$d;ILvg2;Landroidx/core/hardware/fingerprint/FingerprintManagerCompat$b;Landroid/os/Handler;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p2, p1}, Lbf6;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public cancelAuthentication(I)V
    ...
    invoke-static {p1, v0}, Lbf6;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Landroidx/biometric/BiometricViewModel;->k()Lwg2;

    move-result-object p1

    invoke-virtual {p1}, Lwg2;->a()V
...
.method public dismiss()V
    ...
    invoke-virtual {v0, p0}, Landroidx/fragment/app/e;->q(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/e;
    ...
    invoke-static {v0, v1}, Lvm5;->e(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public onAuthenticationError(ILjava/lang/CharSequence;)V
    ...
    sget v0, Lmkf;->default_error_msg:I
...
.method public onAuthenticationFailed()V
    ...
    sget v0, Lmkf;->fingerprint_not_recognized:I

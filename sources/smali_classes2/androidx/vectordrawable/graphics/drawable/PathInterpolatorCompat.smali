...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 3
    sget-object v0, Lwh;->l:[I

    invoke-static {p1, p2, p3, v0}, Liek;->r(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method private parseInterpolatorFromTypeArray(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p2, v0}, Liek;->q(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v0, v1}, Liek;->l(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p2, v1}, Liek;->q(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v0, v2, v3}, Liek;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v0

    const/4 v2, 0x1

    invoke-static {p1, p2, v1, v2, v3}, Liek;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v1

    const-string v2, "controlX2"

    invoke-static {p2, v2}, Liek;->q(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z

    move-result v4

    const-string v5, "controlY2"

    invoke-static {p2, v5}, Liek;->q(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v2, v4, v3}, Liek;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    const/4 v4, 0x3

    invoke-static {p1, p2, v5, v4, v3}, Liek;->j(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

...
# static fields
.field public static final k:Lnk8;

.field public static final l:Lnk8;

.field public static final m:Lnk8;

.field public static final n:Lnk8;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lwm6;->p:Lnk8;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/util/Map;Livj;Lgj0;Z)V
    .locals 1
    ...
    :goto_0
    iput-object v0, p0, Lwm6;->a:Landroid/content/Context;
    ...
    iput-object p2, p0, Lwm6;->b:Lrk8;

    .line 5
    iput-object p3, p0, Lwm6;->d:Livj;

    .line 6
    iput-object p4, p0, Lwm6;->e:Lgj0;

    .line 7
    iput-boolean p5, p0, Lwm6;->c:Z
    ...
    .line 10
    invoke-direct {p0, p2}, Lwm6;->l(I)J

    move-result-wide p2

    iput-wide p2, p0, Lwm6;->g:J

    .line 11
    new-instance p2, Lvm6;

    invoke-direct {p2, p0}, Lvm6;-><init>(Lwm6;)V
...
.method public synthetic constructor <init>(Landroid/content/Context;Ljava/util/Map;Livj;Lgj0;ZLwm6$a;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, Lwm6;-><init>(Landroid/content/Context;Ljava/util/Map;Livj;Lgj0;Z)V

    return-void
.end method

.method public static synthetic j(Lwm6;I)V
    .locals 0

    invoke-direct {p0, p1}, Lwm6;->o(I)V
...
.method private l(I)J
    ...
    iget-object v0, p0, Lwm6;->j:Ljava/lang/String;

    invoke-static {v0, p1}, Lwm6;->m(Ljava/lang/String;I)J
...
.method private static m(Ljava/lang/String;I)J
    ...
    invoke-static {p0}, Lwm6;->k(Ljava/lang/String;)[I
...
.method private declared-synchronized o(I)V
    ...
    iget-object v0, p0, Lwm6;->a:Landroid/content/Context;

    invoke-static {v0}, Lork;->W(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lwm6;->j:Ljava/lang/String;

    :cond_4
    invoke-direct {p0, p1}, Lwm6;->l(I)J

    move-result-wide v0

    iput-wide v0, p0, Lwm6;->g:J

    iget-object p1, p0, Lwm6;->e:Lgj0;

    invoke-interface {p1, v0, v1}, Lgj0;->i(J)V

    iget-object p1, p0, Lwm6;->d:Livj;

    invoke-interface {p1}, Livj;->reset()V
    :try_end_2
...
.method public declared-synchronized a()J
    ...
    :try_start_0
    iget-object v0, p0, Lwm6;->e:Lgj0;

    invoke-interface {v0}, Lgj0;->a()J
...
.method public declared-synchronized b()J
    ...
    :try_start_0
    iget-object v0, p0, Lwm6;->d:Livj;

    invoke-interface {v0}, Livj;->b()J
...
.method public declared-synchronized c(Ljj0$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Lgj0;->c(Ljj0$a;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized e(Landroid/os/Handler;Ljj0$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Lgj0;->e(Landroid/os/Handler;Ljj0$a;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized f(Landroidx/media3/datasource/a;Landroidx/media3/datasource/c;Z)V
    ...
    :try_start_0
    invoke-static {p2, p3}, Lwm6;->n(Landroidx/media3/datasource/c;Z)Z
    ...
    :cond_0
    :try_start_1
    iget-object p3, p0, Lwm6;->d:Livj;

    invoke-interface {p3, p2}, Livj;->a(Landroidx/media3/datasource/c;)V

    iget-object p2, p0, Lwm6;->e:Lgj0;

    invoke-interface {p2, p1}, Lgj0;->j(Landroidx/media3/datasource/a;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized g(Landroidx/media3/datasource/a;Landroidx/media3/datasource/c;ZI)V
    ...
    invoke-interface {p2, p1, p4}, Lgj0;->h(Landroidx/media3/datasource/a;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized h(Landroidx/media3/datasource/a;Landroidx/media3/datasource/c;Z)V
    ...
    invoke-interface {p2, p1}, Lgj0;->g(Landroidx/media3/datasource/a;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized i(Landroidx/media3/datasource/a;Landroidx/media3/datasource/c;Z)V
    ...
    invoke-interface {p3, p2}, Livj;->c(Landroidx/media3/datasource/c;)V

    iget-object p2, p0, Lwm6;->e:Lgj0;

    invoke-interface {p2, p1}, Lgj0;->f(Landroidx/media3/datasource/a;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

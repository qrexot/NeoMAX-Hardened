...
# direct methods
.method public constructor <init>(Lx41;Lere;)V
    .locals 2
    ...
    invoke-direct {p0, p2, v0, v1}, Lftb;-><init>(Lere;Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Ldt0;->f:Lx41;
...
.method public bridge synthetic g(Ljava/io/Closeable;)Ljava/io/Closeable;
    ...
    invoke-virtual {p0, p1}, Ldt0;->l(Lql3;)Lql3;
...
.method public bridge synthetic j(Lfre;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ldt0;->m(Lfre;)Landroid/util/Pair;
...
.method public m(Lfre;)Landroid/util/Pair;
    ...
    invoke-interface {v0, v1, v2}, Lx41;->c(Lcom/facebook/imagepipeline/request/a;Ljava/lang/Object;)Lu41;

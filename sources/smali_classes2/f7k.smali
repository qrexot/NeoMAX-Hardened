...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lf7k;->a:Landroid/graphics/RectF;
...
.method public static b(Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    invoke-static {v0}, Lf7k;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
    ...
    sget-object v1, Lf7k;->a:Landroid/graphics/RectF;
...
.method public static d(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    invoke-static {p0, p1, p2, v0}, Lf7k;->e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    :cond_0
    invoke-static {p1}, Lf7k;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static f(Landroid/graphics/Rect;I)Landroid/util/Size;
    ...
    invoke-static {p0}, Lf7k;->m(Landroid/graphics/Rect;)Landroid/util/Size;

    move-result-object p0

    invoke-static {p0, p1}, Lf7k;->q(Landroid/util/Size;I)Landroid/util/Size;
...
.method public static j(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    invoke-static {p0, v0, p1, v0}, Lf7k;->k(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method public static l(Landroid/graphics/Matrix;)Z
    ...
    invoke-static {v1, v3, v4, v0}, Lf7k;->a(FFFF)F
...
.method public static q(Landroid/util/Size;I)Landroid/util/Size;
    ...
    invoke-static {p0}, Lf7k;->o(Landroid/util/Size;)Landroid/util/Size;
...
.method public static r(Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    invoke-static {p0, v0, v0}, Lf7k;->s(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static t(Landroid/util/Size;)Landroid/graphics/RectF;
    ...
    invoke-static {p0, v0, v0}, Lf7k;->u(Landroid/util/Size;II)Landroid/graphics/RectF;

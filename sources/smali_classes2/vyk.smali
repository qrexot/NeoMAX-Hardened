...
.method public constructor <init>(Lsyk;)V
    ...
    iput-object v0, p0, Lvyk;->d:Ljava/util/Set;

    iput-object p1, p0, Lvyk;->a:Lsyk;

    invoke-interface {p1}, Lsyk;->j()I
    ...
    iput-object v1, p0, Lvyk;->b:Landroid/util/Range;

    invoke-interface {p1}, Lsyk;->h()I
    ...
    iput-object p1, p0, Lvyk;->c:Landroid/util/Range;
...
.method public static l(Lsyk;Landroid/util/Size;)Lsyk;
    .locals 2
    ...
    invoke-interface {p0, v0, v1}, Lsyk;->b(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lsyk;->e()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lsyk;->f()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lvyk;-><init>(Lsyk;)V
    ...
    invoke-virtual {v0, p1}, Lvyk;->k(Landroid/util/Size;)V
...
.method public a(I)Landroid/util/Range;
    ...
    iget-object v0, p0, Lvyk;->c:Landroid/util/Range;
    ...
    iget-object p1, p0, Lvyk;->c:Landroid/util/Range;
    ...
    iget-object p1, p0, Lvyk;->b:Landroid/util/Range;
...
.method public d(I)Landroid/util/Range;
    ...
    iget-object v0, p0, Lvyk;->b:Landroid/util/Range;
...
.method public i(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lsyk;->i(II)Z
    ...
    :cond_0
    iget-object v0, p0, Lvyk;->d:Ljava/util/Set;

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Luwk;->a:Ljava/util/Map;
...
.method public static a(Lh26;)Ljava/lang/String;
    .locals 3
...
.method public static b(Ljava/lang/String;I)Lryk;
    .locals 2

    sget-object v0, Luwk;->a:Ljava/util/Map;
    ...
    sget-object p0, Lryk;->a:Lryk;

    return-object p0
.end method

.method public static c(Lp6l;Landroid/util/Range;)Lsh2;
    .locals 5

    sget-object v0, Lr8j;->q:Landroid/util/Range;
    ...
    invoke-direct {p1, v1, p0}, Lsh2;-><init>(II)V

    return-object p1
.end method

.method public static d(Ln3l;Ljvj;Lp6l;Landroid/util/Size;Lh26;Landroid/util/Range;)Loyk;
    .locals 8

    invoke-virtual {p0}, Ln3l;->d()Lcc6$c;
    ...
    invoke-direct/range {v0 .. v7}, Lqyk;-><init>(Ljava/lang/String;Ljvj;Lp6l;Landroid/util/Size;Lcc6$c;Lh26;Landroid/util/Range;)V
    ...
    invoke-direct/range {v1 .. v7}, Lpyk;-><init>(Ljava/lang/String;Ljvj;Lp6l;Landroid/util/Size;Lh26;Landroid/util/Range;)V
...
.method public static e(Lhsa;Lh26;Lj7l;)Ln3l;
    .locals 11
    ...
    invoke-static {v0}, Lhsa;->h(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Ln26;->c(Lh26;)Ljava/util/Set;

    move-result-object v5

    invoke-static {p1}, Ln26;->b(Lh26;)Ljava/util/Set;

    move-result-object v6

    invoke-interface {p2}, Lcc6;->e()Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {v8}, Lcc6$c;->i()Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lon9;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Luwk;->a(Lh26;)Ljava/lang/String;
    ...
    :cond_6
    :goto_3
    invoke-static {v0}, Ln3l;->c(Ljava/lang/String;)Ln3l$a;

    move-result-object p0

    if-eqz v8, :cond_7

    invoke-virtual {p0, v8}, Ln3l$a;->c(Lcc6$c;)Ln3l$a;

    :cond_7
    invoke-virtual {p0}, Ln3l$a;->b()Ln3l;
...
.method public static f(IIIIIIIIILandroid/util/Range;)I
    ...
    invoke-static {v4}, Lon9;->f(Ljava/lang/String;)Z
    ...
    :goto_0
    sget-object v3, Lp6l;->a:Landroid/util/Range;
...
.method public static g(Loyk;Z)Loyk;
    .locals 2
    ...
    invoke-virtual {v0}, Landroidx/camera/video/internal/compat/quirk/MediaCodecDefaultDataSpaceQuirk;->g()Lryk;

    move-result-object p1

    invoke-virtual {p0}, Loyk;->m()Loyk$a;

    move-result-object p0

    invoke-virtual {p0, p1}, Loyk$a;->e(Lryk;)Loyk$a;

    move-result-object p0

    invoke-virtual {p0}, Loyk$a;->a()Loyk;

...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v6}, Landroidx/camera/core/impl/y;->f()Landroid/util/Size;
    ...
    invoke-static/range {p0 .. p5}, Lcal;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
...
.method public static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lcal;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p0, p1}, Lcal;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lcal;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v1, p1}, Lcal;->e(FF)F
    ...
    invoke-static {v3, p1}, Lcal;->e(FF)F
...
.method public static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v2, p1}, Lcal;->f(FF)F
    ...
    invoke-static {p0, p1}, Lcal;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4}, Lcal;->h(ZI)Z

    move-result p2

    invoke-static {p2, p5, p0, p1}, Lcal;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;

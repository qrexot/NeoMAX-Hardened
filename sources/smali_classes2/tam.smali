...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Ltam;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ltam;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v0, v1}, Lkbm;->e(Ljava/lang/String;I)I
    ...
    invoke-static {p1, v1}, Lkbm;->e(Ljava/lang/String;I)I
    ...
    iput v0, p0, Ltam;->aVertexCoordLoc:I

    invoke-static {p1, v0}, Lkbm;->d(Ljava/lang/String;I)V
    ...
    iput v2, p0, Ltam;->aTextureCoordLoc:I

    invoke-static {p1, v2}, Lkbm;->d(Ljava/lang/String;I)V
    ...
    iput v3, p0, Ltam;->mvpMatrixLoc:I

    invoke-static {p1, v3}, Lkbm;->d(Ljava/lang/String;I)V
    ...
    iput v3, p0, Ltam;->texMatrixLoc:I
    ...
    iput v3, p0, Ltam;->textureLocation:I
    ...
    iput v1, p0, Ltam;->alphaLocation:I

    invoke-static {p1, v3}, Lkbm;->d(Ljava/lang/String;I)V

    new-instance p1, Lb9m;

    invoke-direct {p1, v0, v2}, Lb9m;-><init>(II)V

    iput-object p1, p0, Ltam;->frame:Lb9m;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Ltam;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Ltam;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ltam;->firstFreeTexture:I
    ...
    invoke-static {p1}, Lkbm;->c(Ljava/lang/String;)V

    iget p1, p0, Ltam;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Ltam;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Ltam;->frame:Lb9m;

    iget-object v0, v0, Lo9m;->a:Liam;

    invoke-interface {v0}, Liam;->a()V

    iget v0, p0, Ltam;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Ltam;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Ltam;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Ltam;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Ltam;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Ltam;->firstFreeTexture:I

    iget-object v1, p0, Ltam;->mvpMat:[F
    ...
    iput-object v1, p0, Ltam;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Ltam;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Ltam;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Ltam;->programId:I

    invoke-static {v1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    const-string v1, "glUseProgram"

    invoke-static {v1}, Lkbm;->c(Ljava/lang/String;)V

    iget v1, p0, Ltam;->mvpMatrixLoc:I

    iget-object v2, p0, Ltam;->mvpMat:[F
    ...
    iget v2, p0, Ltam;->texMatrixLoc:I

    iget-object v4, p0, Ltam;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Lkbm;->c(Ljava/lang/String;)V

    iget v0, p0, Ltam;->textureLocation:I

    invoke-virtual {p0}, Ltam;->getTarget()I

    move-result v1

    iget v2, p0, Ltam;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Ltam;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Ltam;->alphaLocation:I

    iget v1, p0, Ltam;->alpha:F
    ...
    iget-object v3, p0, Ltam;->customParams:Ljava/util/HashMap;

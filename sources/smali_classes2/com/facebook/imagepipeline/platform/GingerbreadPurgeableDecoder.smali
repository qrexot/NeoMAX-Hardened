...
.method public constructor <init>()V
    ...
    invoke-static {}, Lxol;->i()Lvol;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lvol;

    return-void
.end method

.method public static h(Lql3;I[B)Landroid/os/MemoryFile;
    .locals 7
    ...
    invoke-direct {v4, v5}, Lshe;-><init>(Lcom/facebook/common/memory/PooledByteBuffer;)V
    :try_end_0
    ...
    invoke-direct {v5, v4, p1}, Ltc9;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v5, v3}, Lc31;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    invoke-static {v4}, Lul3;->b(Ljava/io/InputStream;)V

    invoke-static {v5}, Lul3;->b(Ljava/io/InputStream;)V

    invoke-static {v3, v1}, Lul3;->a(Ljava/io/Closeable;Z)V
    ...
    invoke-static {v3}, Lul3;->b(Ljava/io/InputStream;)V

    invoke-static {v5}, Lul3;->b(Ljava/io/InputStream;)V

    invoke-static {p2, v1}, Lul3;->a(Ljava/io/Closeable;Z)V
...
.method public c(Lql3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->i(Lql3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public d(Lql3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->i(Lql3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final i(Lql3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lql3;I[B)Landroid/os/MemoryFile;
    ...
    iget-object p3, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lvol;

    if-eqz p3, :cond_1

    invoke-interface {p3, p2, v0, p4}, Lvol;->b(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object p2

    const-string p3, "BitmapFactory returned null"

    invoke-static {p2, p3}, Lcle;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lbuj;->a(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
